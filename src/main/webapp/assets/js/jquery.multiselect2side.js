...
(function($)
{
	jQuery.fn.multiselect2side = function (o) {
		...
		return this.each(function () {
			...
			// UP AND DOWN
			var divUpDown =
					"<div id='ms2side__updown' class='ms2side__updown'>" +
			...
			var htmlToAdd = 
				"<div id='ms2side__div' class='ms2side__div'>" +
						((o.selectedPosition != 'right' && o.moveOptions) ? divUpDown : "") +
					"<div class='ms2side__select'>" +
						(o.labelsx ? ("<div class='ms2side__header'>" + o.labelsx + "</div>") : "") +
						"<select title='" + o.labelsx + "' name='" + nameSx + "' id='" + nameSx + "' size='" + size + "' multiple='multiple' data-bind='options: nonSelectItems'></select>" +
					"</div>" +
					...
					"<div class='ms2side__select'>" +
						...
						"<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple' data-bind='options: items' ></select>" +
					"</div>" +
					((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
					"<button type='button' style='margin-top:140px;' data-bind='click: $root.btnSubmitSelectDate, enable: wdCmdRuleOption().code == 3 && !booleanValue()'>确定</button> " +
				"</div>";
			$(this).after(htmlToAdd).hide();// data-bind='options: items'    
