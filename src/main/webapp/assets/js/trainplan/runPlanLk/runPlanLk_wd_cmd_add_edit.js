...
//		    		   self.nodeId(id);
		...
		_self.btnEventSaveWdCmdTrain = function() {
			...
			_self.wdCmdTrain().importantFlag(_self.wdCmdTrain().importOption().code);
			 ...
			 _self.wdCmdTrain().endStn($("#ddlOrgCity1").val());
...
//					console.log(result.message);
	...
	_self.importChange = function() {
		_self.wdCmdTrain().wdCmdRuleOption();
...
//    });
	...
	_self.wdCmdRuleOption = ko.observable(wdCmdRuleArray[i]);					//文电加开开行规律下拉框选中项
