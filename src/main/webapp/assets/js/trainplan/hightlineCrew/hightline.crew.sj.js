...
//										row.isMatch("0");
		...
		_self.exportExcel = function() {
			...
			window.open(basePath+"/crew/highline/exportExcel/2/"+_runDate+"/"+_trainNbr+"/"+_highlineFlag);
		};
...
function heightAuto(){
	...
	$("#right_height").css("height",WH-128+"px");
};
