...
function heightAuto(){
	...
	//alert("window: 860---"+WH);
	$("#plan_view_div_palnDayDetail").css("height",WH-170+"px");
};
...
//选左侧的路局
function chioseBureauClick(bureauCode) {
	cross.searchModle().bureau(bureauCode);
	cross.loadCrosses();
}
//查询图定开行计划
function searchPlanForTD() {
}
//查询临客开行计划
function searchPlanForLK() {
}
