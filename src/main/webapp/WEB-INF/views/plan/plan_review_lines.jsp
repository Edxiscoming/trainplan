...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/plan/plan_review_lines.js"></script>
...
<body class="Iframe_body" style="padding:5px 10px 5px 10px;">
...
<div class="pull-left" style="width:63%;" id="leftBox"> 
    <!--分栏框开始-->
...
<!-- 										始发局:&nbsp;</label>  -->
<!-- 				   <div class="pull-left"> -->
<!-- 						<select style="width: 70px" id="input_cross_chart_id" -->
...
<!-- 					</div> -->
				 ...
				 <label for="exampleInputEmail3" class="control-label pull-left" style="margin-top:5px;margin-left:15px">
				  ...
				  <label for="exampleInputEmail3" class="control-label pull-left" style="margin-top:5px;margin-left:15px">始发局:&nbsp;</label> 
				   ...
				   <div class="pull-left">
					...
					<br/>
					&nbsp;
					<label for="exampleInputEmail3" class="control-label pull-left" style="margin-top:5px;">落成状态:&nbsp;</label> 
  ...
  <div class="pull-left" style="width:36%;" id="rightBox"> 
    <!--分栏框开始-->
    <div id="plan_view_div_palnDayDetail" class="panel panel-default" style="">     
