...
<script type="text/javascript"
	src="<%=basePath%>/assets/js/trainplan/plan/plan_runline_check.js"></script>
...
<body class="Iframe_body"
	style="margin-left: 11px; margin-top: -7px; margin-right: -5px; width: 99%">
	<input id="basePath_hidden" type="hidden" value="<%=basePath%>">
	<div class="pull-left" style="width: 62%; margin-left: -5px;"
		id="leftBox">
			...
			<form class="form-horizontal margin" role="form">
				...
				<div class="pull-left" style="margin-left: -8px;">
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px; margin-left: 10px"> 方案:&nbsp;</label>
					<div class="pull-left">
						<select style="padding: 1px 6px; width: 230px"
							id="input_cross_chart_id" class="form-control"
							data-bind="options:searchModle().charts, value: searchModle().chart, optionsText: 'name'">
						</select>
					</div>
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px; margin-left: 13px"> 始发局:&nbsp;</label>
					<div class="pull-left">
						<select style="padding: 1px 8px; width: 66px"
							id="input_cross_chart_id" class="form-control"
							data-bind="options:searchModle().startBureaus(), value: searchModle().startBureau,  optionsValue: 'shortName', optionsText: 'shortName', optionsCaption: ''">
						</select>
					</div>
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px; margin-left: 13px"> 终到局:&nbsp;</label>
					<div class="pull-left">
						<select style="padding: 1px 8px; width: 66px"
							id="input_cross_chart_id" class="form-control"
							data-bind="options:searchModle().endBureaus(), value: searchModle().endBureau, optionsValue: 'shortName', optionsText: 'shortName', optionsCaption: ''">
						</select>
					</div>
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px; margin-left: 13px"> 途经局:&nbsp;</label>
					<div class="pull-left">
						<select style="padding: 1px 8px; width: 66px"
							id="input_cross_chart_id" class="form-control"
							data-bind="options:searchModle().passBureaus, value: searchModle().passBureau,  optionsValue: 'shortName', optionsText: 'shortName', optionsCaption: ''">
						</select>
					</div>
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px;margin-left: 13px"> 列车类型:&nbsp;</label>
					<div class="pull-left">
						<select style="padding: 1px 6px; width: 120px"
							id="input_cross_chart_id" class="form-control"
							data-bind="options:searchModle().businesses, value: searchModle().business, optionsText: 'name'">
						</select>
					</div>
				</div>
				...
				<div class="pull-left" style="margin-top: 5px;">
					<div class="form-group"
						style="float: left; margin-left: 2px; margin-bottom: 0;">
						<label for="exampleInputEmail3" style="margin-top: 5px" class="control-label pull-left"> 车次:&nbsp;</label>
						<div class="pull-left">
							<input type="text" id="plan_construction_input_trainNbr" class="form-control" style="padding: 4px 12px; width: 100px;"
					...
					<div class="pull-left">
						<input type="checkbox" class="pull-left" class="form-control"
							value="1"
							data-bind="checked: searchModle().fuzzyFlag(), event:{change: fuzzyChange}"
							style="width: 20px; margin-left: 25px; margin-top: 7px"
							class="form-control">
					</div>
						<label for="exampleInputEmail5" class="control-label pull-left" style="margin-top: 5px;"> 模糊</label> 
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px; margin-left: 30px"> 始发站:&nbsp;</label>
					<div class="pull-left">
						<input name="input_cmdTrainTimes_stnName" class="form-control" style="padding: 4px 12px; width: 100px;"
								data-bind="value: searchModle().sourceNodeName,event:{focus: stnNameTempOnfocusS}" />
					</div>
					<div class="pull-left" style="margin-top: 5px; margin-left: 13px">
						<input type="button" id="stn_jh" value="→" data-bind="click: exchangeStn"/> 
					</div>
					<label for="exampleInputEmail3" class="control-label pull-left"
						style="margin-top: 5px; margin-left: 13px"> 终到站:&nbsp;</label>
					<div class="pull-left">
						<input name="input_cmdTrainTimes_endName" class="form-control" style="padding: 4px 12px; width: 100px;"
								data-bind="value: searchModle().targetNodeName,event:{focus: stnNameTempOnfocusE}" />
					</div>
					
						<a type="button" style="margin-left: 13px" class="btn btn-success btn-input" data-toggle="modal" data-target="#" id="plan_construction_createRunLine" data-bind="click: loadTrains">
						<i class="fa fa-search"></i>查询</a> 
						<a type="button" style="margin-left: 13px" class="btn btn-success btn-input" data-toggle="modal" data-target="#" id="plan_construction_canvas_trainTime" data-bind="click: showTrainTimeCanvas">
						<i class="fa fa-line-chart"></i>运行图</a>
		...
		<div id="plan_view_div_palnDayDetail" class="panel panel-default">
			<div style="margin: 8px 0;"
				data-bind="template: { name: 'tablefooter-short-template', foreach: trainRows }"></div>

			<div class="row" style="margin: 5px 10px 10px 10px;">
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover"
						id="plan_runline_table_trainInfo">
						<thead>
							<tr>
					...
					<div id="left_height" style="overflow-y: auto;">
						<table class="table table-bordered table-striped table-hover"
							...
							<tbody data-bind="foreach: trainRows.rows">
								<tr
									data-bind="click: $parent.showTrainTimes, style:{color: $parent.currentTrain() != null && $parent.currentTrain().name == name ? 'blue':''}">
									<td style="width: 55px;" align="center"
										data-bind="text: $parent.trainRows.currentIndex()+$index()+1"></td>
									<td style="width: 100px;"
										data-bind="text: name , attr:{title: name}"></td>
									<td style="width: 60px;" align="center"
										data-bind="text: startBureau"></td>
									<td style="width: 140px; max-width: 140px"
										data-bind="text: startStn , attr:{title: startStn}"></td>
									<td style="width: 80px; max-width: 80px" align="center"
									...
									<td style="width: px;" align="center"
										data-bind="text: routingBureau, attr:{title: routingBureau}"></td>
									<td style="width: 65px;" align="center"
										data-bind="text: runDays"></td>
									<td style="width: 146px;" align="center"
										data-bind="text: expirationDate , attr:{title: expirationDate}"></td>
		...
		<div id="plan_view_div_palnDayDetail" class="panel panel-default"
			...
			<div class="panel-heading" style="height: 33px;">
				<h3 class="panel-title" style="float: left;">
					<i class="fa fa fa-list-ul"
						style="line-height: 32px; padding-right: 7px;"></i>时刻表 <span><input
						type="checkbox" id="input_checkbox_stationType_jt"
						name="input_checkbox_stationType" checked="checked"
						style="margin-left: 10px">简点</span> <span
						style="margin-left: 5px"
						data-bind="text:currentTrain() == null ? '' : '车次:' + currentTrain().name"></span>
			...
			<div class="panel-body" style="padding: 10px;">
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover"
						...
						<thead>
							<tr>
								<th style="vertical-align: middle; width: 40px" rowspan="2">序号</th>
								<th style="vertical-align: middle; width: 120px" rowspan="2">站名</th>
								<th style="vertical-align: middle; width: 40px" rowspan="2">路局</th>
								<th style="vertical-align: middle; width: 80px" rowspan="2">到达时间</th>
								<th style="vertical-align: middle; width: 80px" rowspan="2">出发时间</th>
								<th style="vertical-align: middle; width: 80px" rowspan="2">停时</th>
								<th style="vertical-align: middle; width: 100px" colspan="2">天数</th>
								<!--                   <th style="width:63px">出发天数</th> -->
								<th style="vertical-align: middle; width: 100px" colspan="2"
									class="text-center">车次</th>
								<th style="vertical-align: middle; width: 50px" rowspan="2">股道</th>
								<th style="vertical-align: middle; width: 50px" rowspan="2">站台</th>
								<th style="vertical-align: middle; width: 80px" rowspan="2">作业</th>
								<th style="vertical-align: middle; width: %" rowspan="2">客运</th>
								<th style="vertical-align: middle; width: 17px" align="center"
									rowspan="2"></th>
							</tr>
							<tr>
								<th style="vertical-align: middle; width: 60px"
									class="text-center">到达</th>
								<th style="vertical-align: middle; width: 60px"
									class="text-center">出发</th>
								<th style="vertical-align: middle; width: 60px"
									class="text-center">到达</th>
								<th style="vertical-align: middle; width: 60px"
									class="text-center">出发</th>
							...
							<tbody data-bind="foreach: trainLines">
								<tr>
									...
									<td style="width: 80px" align="center"
										data-bind="text: sourceTime, attr:{title: sourceTime}"></td>
									<td style="width: 80px" align="center"
										data-bind="text: targetTime, attr:{title: targetTime}"></td>
									<td style="width: 80px" align="center"
										data-bind="text: stepStr"></td>
									<td style="width: 63px" align="center"
										data-bind="text: arrRunDays"></td>
									<td style="width: 63px" align="center"
										data-bind="text: runDays"></td>
									<td style="width: 63px" align="center"
										data-bind="text: sourceTrainNbr, attr:{title: sourceTrainNbr}"></td>
									<td style="width: 63px" align="center"
										data-bind="text: targetTrainNbr, attr:{title: targetTrainNbr}"></td>
									<td style="width: 50px" align="center"
										data-bind="text: trackName, attr:{title: trackName}"></td>
									<td style="width: 63px" align="center"
										data-bind="text: platForm, attr:{title: platForm}"></td>
									<td style="width: 80px" align="center"
										data-bind="text: jobsText, attr:{title: jobsText}"></td>
									<td style="width: %" align="center" data-bind="text: kyyy"></td>
									<td style="width: 17px" align="center" class="td_17"></td>
								</tr>
							</tbody>
						</table>
