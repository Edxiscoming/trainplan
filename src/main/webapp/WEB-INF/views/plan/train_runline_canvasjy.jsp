...
<div class="row">
  <div style="float:left;">
    ...
    <div class="panel panel-default margin">
      <!--panle-heading-->
      <div class="panel-body panel-body_iframe" style="padding: 0 35px 0 34px;">
    	<div class="row">
	      <div class="row fix_box">
              <div class="row Operation_box" style="width:520px;">
...
<script src="<%=basePath %>/assets/js/trainplan/plan/train_runline_canvasjy.js"></script>
