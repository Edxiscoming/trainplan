...
<% 
 ShiroRealm.ShiroUser user = (ShiroRealm.ShiroUser)SecurityUtils.getSubject().getPrincipal();
	String  currentBureauShortName = ""; 
	String currentUserBureau = "";
if(null == user) {	
 }
 else {
	currentBureauShortName = user.getBureauShortName();
	currentUserBureau = user.getBureau();
 }
/*
...
<body class="Iframe_body" style="height:100%;margin: -29px -6px 0px -4px;width:100%">
	 <div id="div_searchForm" class="row" style="margin:0px 0 0px 0;"> 
	    <form class="form-horizontal" role="form">
	   	<div class="row" style="margin:20px 0 0px 0;">
		      <div class="pull-left" > 
		        <div class="pull-left"> 
					 <label for="exampleInputEmail3" style="margin-left: 10px;margin-top:5px;">
														日期:&nbsp;</label> 
					 <input type="text" class="form-control" style="padding:4px 12px; width:95px;display:inline-block;" placeholder="" id="runplan_input_startDate"  name="startDate" data-bind="value: searchModle().planStartDate" />
				 </div>
				 <div class="pull-left" style="margin-left:10px"> 
					 <label for="exampleInputEmail5" style="margin-top:5px;">路局:&nbsp;</label> 
					 <select class="form-control" style="padding:4px 12px;width: 76px;display:inline-block;" id="input_cross_filter_showFlag"
							 data-bind="options: searchModle().bureaus, value: searchModle().crossBureau, optionsText: 'shortName', optionsValue: 'code', optionsCaption: '',event:{change: searchModle().crossBureauChange}">
					 </select> 
				  </div>
				 <div class="pull-left" style="margin-left:10px"> 
					 <label for="exampleInputEmail5" style="margin-top:5px;">铁路线:&nbsp;</label> 
				   ...
				   <div class="pull-left" style="margin-left:10px"> 
					 <label for="exampleInputEmail5" style="margin-top:5px;">担当局:&nbsp;</label> 
					 <select class="form-control" style="padding:4px 12px; width: 76px;display:inline-block;" id="input_cross_filter_showFlag"
							 data-bind="options: searchModle().bureaus, value: searchModle().bureau, optionsText: 'shortName', optionsValue: 'code', optionsCaption: ''">
					 </select> 
				  </div>
				   <div class="pull-left" style="margin-left:10px"> 
					 <label for="exampleInputEmail5" style="margin-top:5px;">动车所:&nbsp;</label> 
					 <select class="form-control" style="padding:4px 12px; width: 130px;display:inline-block;" id="input_cross_filter_showFlag"
				  ...
				  <div class="pull-left" style="margin-left:10px"> 
					  	<label for="exampleInputEmail3" style="margin-top:5px;">动车台:&nbsp;</label> 
						<select class="form-control" style="padding:4px 12px; display:inline-block;width: 130px;" data-bind="options:searchModle().accs, value: searchModle().searchAcc, optionsText: 'name', optionsValue:'name', optionsCaption: ''">
						</select>
				  </div>
				  <div class="pull-left" style="margin-left:10px"> 
					 <label for="exampleInputEmail3" style="margin-top:5px;">车次:&nbsp;</label> 
					 <input type="text" class="form-control" style="padding:4px 12px;display:inline-block; width:105px;" data-bind="value: searchModle().trainNbr"/>
				 </div>
				  <a type="button"  style="margin:3px 0 0 10px;" class="btn btn-success btn-input" data-toggle="modal" data-target="#"  data-bind="click: loadCrosses"><i class="fa fa-search"></i>查询</a>
			 </div>
			 
			   <div class="pull-left">
			  <a type="button"  style="margin:3px 0 0 10px;" class="btn btn-success btn-input" data-bind="click: importExcel"><i class="fa fa-sign-out"></i>导出EXCEL</a>
			
			</div>
			 <div class="pull-right" style="margin-right:10px;">
				<input type="checkbox" class="pull-left" style="margin-top:7px;" class="form-control" data-bind="checked: isShowCrossDetailInfo, event:{change: showRunPlans}"> 
				<label for="exampleInputEmail5" class="control-label pull-left" style="margin:4px 0 0 5px;"><b>显示交路详情</b></label>  
		 	</div>
		 </div>
	    </form> 
	  </div>  
					          ...
					          <table class="table table-bordered table-striped table-hover" style="width:100%">
									<thead>
										<tr class="changePadding"> 
											...
											<th style="width: 60px;padding: 4px 0px;" align="center">计划局</th>
						          ...
						          <table class="table table-bordered table-striped table-hover" style="border: 0;">
									<tbody data-bind="foreach: highLineCrossRows">
										<tr data-bind=" visible: visiableRow, style:{color: $parent.currentCross().highLineCrossId == highLineCrossId ? 'blue':''}" >
									        ...
									        <td style="width: 100px" data-bind="text: throughline, click: $parent.showTrains"></td> 
									        <td style="width: 75px" data-bind="text: crossStartDate, click: $parent.showTrains"></td> 
										    ...
										    <td style="width: 40px" data-bind="text: (spareFlag() == 2 ? '是' : '否'), click: $parent.showTrains"></td>
										    <td style="width: 55px" data-bind="text: tokenVehBureauShowValue, click: $parent.showTrains"></td>
										    ...
										    <td style="width: 60px" data-bind="text: createReason, click: $parent.showTrains"></td>
										    <td style="width: 60px;text-align: center;" data-bind="text: crossBureau, click: $parent.showTrains"></td>
...
<script type="text/javascript">
	...
	$(function() {
	   resize("leftBox","rightBox","650","730");
	 });
