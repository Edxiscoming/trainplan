...
<body class="Iframe_body" style="height:100%;margin:-9px -6px 0px -3px;width:100%" >
	...
	<!-- <ol class="breadcrumb">
		...
		<li><a href="#">车底三乘计划 -> 高铁车底运用计划审核</a></li>
	</ol>  --> 
		      ...
		      <div class="pull-left"> 
		        <div class="pull-left"> 
				 ...
				 <div class="pull-left" style="margin-left:10px"> 
				  ...
				  <div class="pull-left" style="margin-left:10px"> 
					  	<label for="exampleInputEmail3" style="margin-top: 6px;">动车台:&nbsp;</label> 
						<select class="form-control" style="padding:4px 12px;width: 150px;display:inline-block;"data-bind="options:searchModle().accs, value: searchModle().searchAcc, optionsText: 'name', optionsValue:'name', optionsCaption: ''">
						</select>
				  </div>
				  <div class="pull-left"> 
					 <label for="exampleInputEmail3" class="control-label pull-left" style="margin-top: 6px;margin-left: 15px;">
														车次:&nbsp;</label> 
					 <input type="text" class="form-control" style="padding:4px 12px;margin-top:3px; width:95px;" data-bind="value: searchModle().trainNbr"/>
				 </div>
	   ...
	   <div id="cmdInfo_dialog" class="easyui-dialog"
	      title="命令预览" data-options="iconCls:'icon-save'"
		   style="width: 600px; height: 500px; padding: 10px;">
	   		...
	   		<div id="cmdInfo_dialog_row2" class="row" style="width:100%; margin-top:10px;margin-bottom:5px">
	   			<div align="center">
...
<script src="<%=basePath %>/assets/js/resizable.js"></script>
