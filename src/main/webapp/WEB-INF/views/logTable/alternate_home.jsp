...
<head> 
    ...
    <script type="text/javascript" src="<%=basePath %>/assets/js/logTable/alternate_home.js"></script>
...
<!-- 					<span id="headerBureau" class=" pull-left" ></span> -->
	                ...
	                <span class="pull-left padding-5"   style="margin-left: 30px;">方案：</span>
	    				...
	    				<div class="col-md-12">
	    					<div class="panel panel-default">
							  ...
							  <div class="panel-body">
							    <div id="crossGraph" style="height:400px;; margin-left:auto; margin-right:auto;">
