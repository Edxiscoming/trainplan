...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>/assets/js/logTable/searchCross.js"></script>
    <title>查询交路</title>
    <style type="text/css">
    	.nav-pills > li{
			color: #333;
...
<body style="width: 100%; height:1080px; overflow-y:hidden;">
    <div class="container-fluid" >
        <div class="pull-left col-md-5" style="height:800px;padding-left:0px;">
            <div class="col-md-12" style="padding: 15px 0px;">
                <span class="pull-left" style="margin-top:7px; margin-left:0px;">方案：</span>
                <div class="pull-left">
                    <select style="padding: 1px 8px;; width: 280px; color:#e60302; font-weight:normal;"
                ...
                <input type="text" class="input-sm form-control pull-right" style="width: 100px;" id="trainNo" onkeyup="upperCase(this.id)">
                <span class="pull-right padding-5" style="margin-left: 30px; margin-top:7px;">车次：</span>
            </div>
           <!--  <div class="col-md-12">
                <div class="btn-group" style="margin-left:-15px; margin-bottom:15px; margin-top:5px;" id="highlineFlag">
                    <button type="button" class="btn btn-default" style="width:90px;" id="highlineFlag_all" value="">全部</button>
                    <button type="button" class="btn btn-default" style="width:90px;" id="highlineFlag_g" value="1">高铁/动车</button>
                    <button type="button" class="btn btn-default" style="width:90px;" id="highlineFlag_p" value="0">普速</button>
                </div>
            </div> -->
            <div class="row">
                <div class="col-md-1">
                    <div class="btn-group-vertical" role="group" id="input_cross_chart_id">

                    </div>
                </div>
                <div class="col-md-11" style="height:800px;">
                    <table id="crossInfos">
        ...
        <div class="pull-right col-md-7" style="padding-right:0px;">
            <div class="row" style="height:550px; width:100%; border:1px solid #ccc;">
                ...
                <div id="myTabContent" class="tab-content" style="height:500px; overflow-y:auto; overflow-x:hidden;">
                    ...
                    <!-- <div onclick="fullScreen();"><button class="btn btn-default greenBtn btn-xs pull-right" style="margin-right:10px;">全屏</button></div> -->
                        <iframe src="" width="100%" height="100%" scroll="no"></iframe>
                    </div>
                    <div class="tab-pane fade" id="crossInfo">
                        <form role="form" class="form-horizontal">
                        <div style="padding-left:60px; border-width: 1px; border-color: rgb(204, 204, 204); border-style: none none dashed none; ">
                        ...
                        <div style="padding-left:60px;">
                            <label style="" class="row margin-top-5">开行规律</label>
                            <div class="row margin-top-5">
                                <div class=" pull-left div-header">
                                    普通规律：
                                    </div>
                        ...
                        <div style="padding-left:60px; border-width: 1px; border-color: rgb(204, 204, 204); border-style: dashed none;">
                            <div class="row margin-top-5">
                                <div class=" pull-left div-header">
                                    运行区段：
                                </div>
                        ...
                        <div>
                            <div class="row margin-top-5" style="margin-left:15px;">
                                <div class="div-header pull-left" style="padding-left:60px;">
                                    备注：
                                </div>
                                <div class="pull-left" id="remark" style="margin-bottom: 5px; width:270px; height:120px;">
			...
			<div class="pull-left" style="width: 97%; height:500px; margin-top:20px;">
				<section class="panel panel-default">
					...
					<ul id="myTab" class="nav nav-pills" role="tablist" style="background-color:#f5f5f5;">
					    ...
					    <!-- <li><a href="#rule" role="tab" data-toggle="pill" >列车信息（对）</a></li> -->
   ...
   <div class="slideblock " id="fullScreen" style="height: 99%;width:99%;overflow-y: auto;margin:auto;display:none;z-index:999;background-color:#fff;border:1px solid #333; position:absolute;top:0px;right:20px;">
