...
<head> 
	...
	<script type="text/javascript" src="<%=basePath %>/assets/js/logTable/importCrossData.js"></script>
...
<body>
    <div class="container-fluid" >
        <div class="row" style="padding: 15px 0px;background: #f9f9f9; border-bottom: solid 1px #E0E0E0;">
            <div class="col-xs-8">
                ...
                <span class="pull-left padding-5"  style="margin-left:30px">车次：</span><input type="text" class="input-sm form-control pull-left" style="width: 200px;" id="trainNo">
                <span class="pull-left padding-5" style="margin-left: 30px;">开行状态：</span>
                <select class="form-control input-sm pull-left" style="width: 80px;" id="runState">
            ...
            <div class="col-xs-4">
                <div class="">
                    ...
                    <a type="button" class="btn btn-sm btn-default greenBtn pull-left" style="margin:0px 20px;" onclick="importExl();">导入</a>
                    <!--<a type="button" class="btn btn-sm btn-default blueBtn pull-left">发消息</a>-->
                </div>
        ...
        <div class="row" style="margin-top: 15px;">
            ...
            <div class="pull-right slideblock " style="height: 800px;width:400px;overflow-y: auto;margin-right: 15px;float:right;display:none;">
                <div style="height: 40px" class="panel-header">
                    ...
                    <a type="button" class="btn btn-default greenBtn btn-sm pull-right closeBlock" style="margin-left: 20px;"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true" onclick="closeSlideBlock();">关闭</span></a>
    ...
    <div id="importExl" title="导入对数表" style="display: none;">
        ...
        <form class="form-horizontal" style="margin-left: 30px;">
            ...
            <div class="form-group">
                <a type="button" id="upload_btn" onclick="uploadFile()" class="btn btn-default btn-default blueBtn">导入</a>
            </div>
        </form>
