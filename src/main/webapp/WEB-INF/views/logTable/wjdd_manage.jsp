        ...
        <div class="container-fluid">
	        <div class="row" style="padding: 15px 0px;background: #f9f9f9; border-bottom: solid 1px #E0E0E0;">
	            <div class="col-xs-12">
	               ...
	               <a class="btn btn-default greenBtn btn-sm pull-left" type="button" style="margin-left: 20px;" onclick="checkData();" name="operationBtn"><span class="glyphicon glyphicon-ok" style="margin-right:5px;"></span>审核通过</a>
	               <a class="btn btn-default greenBtn btn-sm pull-left" type="button" style="margin-left: 20px;" onclick="checkDataNo();" name="operationBtn"><span class="glyphicon glyphicon-remove" style="margin-right:5px;"></span>审核不通过</a>
	    					...
	    					<div class="panel panel-default">
							  <div class="panel-heading">
							    <h3 class="panel-title">运行图
							    	...
							    	<a class="btn btn-default greenBtn btn-sm pull-right" type="button" style="margin-right: 10px; margin-bottom:-3px;" onclick="checkDataNo();" name="operationBtn">审核不通过</a>
							    	<a class="btn btn-default greenBtn btn-sm pull-right" type="button" style="margin-right: 10px; margin-bottom:-3px;" onclick="checkData();" name="operationBtn">审核通过</a>
							    </h3>
							  </div>
