...
<head> 
    ...
    <script type="text/javascript" src="<%=basePath %>/assets/js/logTable/wjdd_manage.js"></script>
...
<body>
	<div style="margin:5px; height:970px; overflow-y:auto; overflow-x:hidden;">
        <div class="container-fluid">
	        <div class="row" style="padding: 15px 0px;background: #f9f9f9; border-bottom: solid 1px #E0E0E0;">
	            <div class="col-xs-12">
	                ...
	                <span class="pull-left padding-5" id="token" style="margin-left: 10px;  ">担当局：</span>
	                <select class="form-control input-sm pull-left" style="width: 65px;padding: 1px 5px;" id="tokenVehBureau">
					...
					<div class="btn-group pull-left" style="margin-left:10px;">
	    				<button type="button" class="btn btn-default active" value="0" onclick="searchData(1,this)" id="allType">全部</button>
	        			<button type="button" class="btn btn-default" value="1" onclick="searchData(1,this)" >通过</button>
	        			<button type="button" class="btn btn-default" value="2" onclick="searchData(1,this)" >到发</button>
 					</div> 
			
	                <a type="button" id="selfSearchBtn" class="btn btn-default blueBtn btn-sm pull-left" style="margin-left: 20px;" onclick="searchData(1);"><span class="glyphicon glyphicon-search" style="margin-right:5px;"></span>查询</a>
	               ...
	               <a class="btn btn-default greenBtn btn-sm pull-left" type="button" style="margin-left: 20px;" onclick="checkData();" name="operationBtn"><span class="glyphicon glyphicon-ok" style="margin-right:5px;"></span>模拟审核通过</a>
	               <a class="btn btn-default greenBtn btn-sm pull-left" type="button" style="margin-left: 20px;" onclick="checkDataNo();" name="operationBtn"><span class="glyphicon glyphicon-remove" style="margin-right:5px;"></span>模拟审核不通过</a>
	    	...
	    	<div class="row">
	    		<div class="col-md-5">
	    			<div class="row tableTop" style="margin-top: 15px;">
			            ...
			            <div class="col-md-12 left" style="height:875px;padding-left:15px;margin-top:5px;">
	    					...
	    					<div class="panel panel-default">
							  <div class="panel-heading">
							    <h3 class="panel-title">
							    	...
							    	<a class="btn btn-default greenBtn btn-sm pull-right" type="button" style="margin-right: 10px; margin-bottom:-3px;" onclick="checkDataNo();" name="operationBtn">模拟审核不通过</a>
							    	<a class="btn btn-default greenBtn btn-sm pull-right" type="button" style="margin-right: 10px; margin-bottom:-3px;" onclick="checkData();" name="operationBtn">模拟审核通过</a>
							    </h3>
							  </div>
							  <div class="panel-body">
							    <div id="crossGraph" style="height:400px;">
							    	<div id="crossGraphAlert"></div>
