...
<script src="${ctx}/assets/lib/fishcomponent.js"></script>
<%-- <script type="text/javascript" src="<%=basePath%>/assets/js/trainplan/common.security.js"></script> --%>
<script src="${ctx}/assets/js/trainplan/util/fishcomponent.js"></script>
<script src="${ctx}/assets/js/trainplan/util/canvas.util.js"></script>
<script src="${ctx}/assets/js/trainplan/util/canvas.component.js"></script> 
<script src="${ctx}/assets/js/trainplan/runPlan/canvas_rightmenu.js"></script>
    <script type="text/javascript" src="${ctx}/assets/js/trainplan/planline_checkGT.js"></script>
    <script type="text/javascript">
                       ...
                       <div id="left_height" style="overflow-y:auto;">
                 		 <table class="table table-bordered table-striped table-hover" style="border: 0;"  data-bind="with: tableModel">  
                            ...
                            <tr>
                                ...
                                <td style="width:90px;padding:4px 0;" class="text-center" data-bind="text: jrTime, attr:{title: jrTime}"></td>
                                <td style="width:130px;padding:4px 0;" class="text-center" data-bind="text: jcStn, attr:{title: jcStn}"></td>
                                <td style="width:90px;padding:4px 0;" class="text-center" data-bind="text: jcTime, attr:{title: jcTime}"></td>
				...
				<table class="table table-bordered table-striped table-hover"
					...
					<table class="table table-bordered table-striped table-hover"
						...
						<tbody data-bind="foreach: sents ">
							<tr>
								<td style="width: 5%"
									data-bind="text: run_date, attr:{title: run_date}"></td>
								<td style="width: 5%" align="center" data-bind="text: train_nbr"></td>
