...
<body class="Iframe_body" style="margin:-8px -9px 0px -8px;width:100%">
<!-- <ol class="breadcrumb">
  <span><i class="fa fa-anchor"></i>当前位置：</span>
  <li><a href="javascript:void(0);">车底三乘计划 -> 高铁站段报告 -> 高铁机械师乘务计划报告</a></li>
</ol> -->
<!--以上为必须要的--> 
...
<div class="row">
  ...
  <!--列车开行计划-->
  <div id="right_div" class="pull-right" style="width:530px;margin-right:15px;margin-left:-5px;"> 
    <!--分栏框开始-->
    <div  id="panel_right_div" class="panel panel-default margin" style="margin-left: -2px;margin-right:-18px">
...
<div id="add_jxs_info_dialog" class="easyui-dialog" title="添加填报司机"
					                  ...
					                  <th style="width: 17px" align="center"></th>
												 ...
												 <div id="allTimes_table" style="height: 530px; overflow-y:auto;"> 
													...
													<tr>
															...
															<td style="width:80px" align="center" data-bind="text: arrTime"></td>
															<td style="width:80px" align="center" data-bind="text: dptTime"></td>
															<td style="width:60px" align="center" data-bind="text: stepStr"></td>
															<td style="width:70px" align="center" data-bind="text: arrRunDays"></td>
