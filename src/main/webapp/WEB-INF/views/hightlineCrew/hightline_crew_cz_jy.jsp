...
<body class="Iframe_body" style="margin:-8px -10px 0px -8px;width:100%">
<!-- <ol class="breadcrumb">
  <span><i class="fa fa-anchor"></i>当前位置：</span>
  <li><a href="javascript:void(0);">车底三乘计划 -> 高铁站段报告 -> 高铁车长乘务计划报告</a></li>
</ol> -->
<!--以上为必须要的--> 
     ...
     <div class="form-group" style="float:left;margin-left:5px;margin-top:7px; margin-bottom:0;">
         <label for="exampleInputEmail3" class="control-label" style="margin-left:30px;margin-top:-7px;">乘务组编号:&nbsp;</label>
		    <div style="margin-left:105px;margin-top:-6px;margin-right:70px;width:50px;">
		        <select  style="width:120px" class="form-control" data-bind="options:searchModle().crewGroups, value: searchModle().crewGroupOption,optionsCaption: '', optionsText: 'crewGroupName' "></select>						    
		    </div>  
     </div>

    <a type="button" href="#" class="btn btn-success btn-input" data-bind="click : queryList" id="chaxun" style="float:left;margin-left:20px;margin-bottom:0;"><i class="fa fa-search"></i>查询</a>
...
<div class="row">
  ...
  <div id="all_div" style="margin-right:-550px; float:left; width:100%;">
    ...
    <div id="panel_div" class="panel panel-default" style="margin:0 550px 0 15px;">
      ...
      <div id="body_div" class="panel-body" style="padding:10px 5px;">
        <div class="row" style="margin-bottom:10px;">
          ...
          <button id="bjdd_btn_editWdCmd" type="button btn-input" class="btn btn-success btn-input" data-toggle="modal" data-bind="click:onEditOpen" data-target="#bjddAddWdjkCmdTrainModal"><i class="fa fa-pencil-square-o"></i> 修改</button>
          ...
          <table class="table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th colspan="3" class="text-center" style="vertical-align: middle">车长</th>
                <th colspan="3" class="text-center" style="vertical-align: middle">业务员</th>
  ...
  <div id="right_div" class="pull-right" style="width:540px;margin-right:-3px;margin-left:-5px;"> 
    <!--分栏框开始-->
    <div id="panel_right_div" class="panel panel-default" style="margin-left: -7px; margin-bottom:0;">
      <div id="panel_head_div" class="panel-heading" >
...
<div id="add_cz_info_dialog" class="easyui-dialog" title="添加填报司机"
...
<script type="text/javascript"  src="<%=basePath %>/assets/js/trainplan/hightlineCrew/hightline.crew.cz.jy.js"></script> 
<script type="text/javascript">
	$(function() {
