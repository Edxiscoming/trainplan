...
<div class="row" style="margin: -3px 13px 10px 7px;"> 
    ...
    <div class="row" style="margin:  -5px 0px 5px 0px;">
      <div>
        <div class="row"  style="width: 100%;">
          <label for="exampleInputEmail3" class="control-label pull-left" style="margin-top: 5px;"> 开始日期1:</label>
        ...
        <div class="row"  style="margin-top: 5px;">
          ...
          <div class="pull-left" style="margin-left: 20px;"> <a type="button" class="btn btn-success btn-input" data-toggle="modal"
															data-target="#" id="btn_cross_search"  data-bind="click: loadCrosses"><i class="fa fa-search"></i>查询</a> </div>
        </div>
 ...
 <div class="blankBox"></div>
  ...
  <div class="pull-right" style="width: 69%;" id="rightBox"> 
    <!-- Nav tabs -->
              ...
              <form class="form-horizontal" role="form" data-bind="with: currentCross">
                ...
                <div class="row" style="margin: 5px 0 0px 0;">
                  ...
                  <div class="pull-left" style="width: 28%;">
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <label for="exampleInputEmail5"  class="control-label pull-left"> 高线规律:</label>
                      <input type="radio" class="pull-left" class="form-control"
