      ...
      <div class="panel-body">
		...
		<div class="row" style="margin-top: 0px">
			<div class="row" style="margin-top: 0px;margin-left:-15px;">
				<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:15px;">备用方式：&nbsp;</label>
			...
			<div class="row" style="margin-top: 10px;margin-left:-15px;">
				<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:15px;">备用依据：&nbsp;</label>
				<div class="pull-left" style="margin-top: 0px;">
			...
			<div class="row">
					<label class="control-label pull-left" style="margin-left:0px;">备用规律：</label>
...
<script src="<%=basePath %>/assets/js/trainplan/runPlan/train_use_to_run.js"></script>
</body>
</html>
