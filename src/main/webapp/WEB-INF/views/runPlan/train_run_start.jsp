      ...
      <div class="panel-body">
		...
		<div class="row" style="margin-top: 0px">
			<div class="row" style="margin-top: 0px;margin-left:-15px;">
				<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:15px;">开行方式：&nbsp;</label>
			...
			<div class="row" style="margin-top: 10px;margin-left:-15px;">
				<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:15px;">开行依据：&nbsp;</label>
				<div class="pull-left" style="margin-top: 0px;">
...
<script src="<%=basePath %>/assets/js/trainplan/runPlan/train_run_start.js"></script>
</body>
</html>
