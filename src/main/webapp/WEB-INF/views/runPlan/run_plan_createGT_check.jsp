...
<body class="Iframe_body"  style="margin: -2px -2px 0 -3px;width: 100%; height:100%;">
<!--  
<ol class="breadcrumb">
...
<!-- 	   <div class="row" style="margin: 10px 10px 10px 10px;">   -->
			      ...
			      <div class="row" style="margin: -5px 15px 10px 10px;"> 
				        	<div class="panel-body">   
								...
								<div class="pull-left" style="margin-left: 5px; display: none;">
									<select disabled style="padding:4px 12px; ;width:75px" class="form-control" data-bind="options:searchModle().bureaus, value: searchModle().bureau, optionsText: 'shortName', optionsValue:'code' ,event:{change: bureauChange}"></select>
								</div> 
							...
							<button  id="generateAll" style="line-height:2.2;" class="btn btn-default greenBtn btn-sm pull-right" data-toggle="modal"
									data-target="#" id="" data-bind="click: handOpen_force" disabled><i class="fa fa-hand-o-right"></i>生成全部</button>
								<!-- <button  id="generateAll" style="line-height:2.2;" class="btn btn-default greenBtn btn-sm pull-right" data-toggle="modal"
									data-target="#" id=""  data-bind="click: createPlan" disabled><i class="fa fa-hand-o-right"></i>生成全部</button>  -->
							</div>  
   	...
   	<div class="row"  style="margin: 5px 3px 10px 10px;" >
	...
	<div class="panel">
    	<div style="position: relative;" class="row" >
	        <form role="form" class="form-inline">
	            <div style="margin:5px 0 10px 50px;" class="row">
	                ...
	                倍｝ <!-- <label for="canvas_checkbox_stationType_jt">
	    ...
	    <div style="height: 350px;width:100%; overflow: auto;"  id="graphPanel">
	        <canvas id="oldGraph" width="60" height="45" style="display:none"></canvas>
	        <canvas id="newGraph" width="60" height="45"  style="display:none"></canvas>
	        <canvas id="mainGraph" width="60" height="45" style=""></canvas>
	        
	    </div>
	    <div style="height: 330px;width:150px; overflow: hidden;display: none;position: absolute; left:0px; top: 39px;background: white;  padding:30px auto;" id="leftX">
            <canvas id="canvas_leftX" width="145" style="left: 0px; top: 0px;position: absolute;"></canvas>
        </div>
	    <div style="height: 330px;width:150px; overflow: hidden;display: none;position: absolute; right:21px; top: 39px;background: white;  padding:30px auto;" id="rightX">
            <canvas id="canvas_rightX" width="145" style="left: 0px; top: 0px;position: absolute;"></canvas>
        </div>
    </div>
     ...
     <div id="autoCreate" title="自动生成设置" style="display: none;overflow-x:hidden; overflow-y:hidden;">
        ...
        <form class="form-horizontal" style="margin-left: 30px;">
            ...
            <div class="form-group" style="margin-left:50px; margin-top:20px;">
                ...
                <input class="pull-left" type="text" style="margin-left:5px;border-radius:5px;width:60px; padding-left:20px;" value="40"  id="createDays">
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlan/alternativeGraph.js"></script>
  ...
  <table style="width:100%;height:20px;">
	<tr style="width:100%;height:20px;">
	 ...
	 <td  style="display:none;color:red" id="generateInfo">
		总交路：<span id="totalNum">0</span>
		已生成：<span id="successNum">0</span>
		失败：<span id="failNum">0</span>
	 </td>
...
<script  type="text/html" id="runPlanTableVlaues"> 
 ...
 <tr data-bind="foreach: runPlans" >
    ...
    <td data-bind="attr:{colspan: $parent.colspan} "><span style="vertical-align: middle; cursor: pointer;" data-bind="html: $parent.createStatusShowValue,event:{click:$parent.showWayGraph}"></span><button data-bind="click: $root.createPlan" class="blueBtn">生成</button></td> 
 	<!-- /ko -->   
 </tr> 
 <!-- /ko -->
 <!-- ko if: trainSort == 1 --> 
