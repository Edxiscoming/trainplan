...
<!-- 	   <div class="row" style="margin: 10px 10px 10px 10px;">   -->
	...
	<div class="panel">
	    ...
	    <div style="height: 350px;width:100%; overflow: auto; position: relative;" id="graphPanel">
	    ...
	    <div style="height: 330px;width:150px; overflow: hidden;display: none;position: absolute; right:15px; top: 39px;background: white;  padding:30px auto;" id="rightX">
