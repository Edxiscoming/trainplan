...
<link rel="stylesheet" type="text/css" media="screen" href="<%=basePath%>/assets/css/runPlan/runPlan_new.css">
...
<div class="row" style="margin: -3px 13px 10px 7px;"> 
  <!--分栏框开始-->
  <div class="pull-left top" style="width: 50%;height:100%" id="leftBox"> 
    <!--分栏框开始-->
    <div class="row" style="margin:  -5px 0px 5px 0px;">
      <div>
        <div class="row"  style="width: 100%;">
          <span for="exampleInputEmail3" class="control-label pull-left" style="margin-top: 7px;"> 担当局:</span>
          <div class="pull-left" style="margin-left: 5px;">
            <select style="padding:4px 12px; ;width:118px" class="form-control" data-bind="options:searchModle().bureaus, value: searchModle().bureau, optionsText: 'shortName', optionsValue:'code', event:{change: bureauChange}">
            </select>
          </div>
          <div class="pull-right">
            <input type="checkBox" class="pull-left" class="form-control"
                          value="1" data-bind="checked: searchModle().currentBureanFlag"
                          style="width: 20px; margin-top: 7px; margin-left:18px; height:15px !important;"
                          class="form-control">
          <span for="exampleInputEmail5" class="control-label pull-left" style="margin-top: 7px;"> 本局相关</span>
          <span for="exampleInputEmail3" class="control-label pull-left" style="margin-top: 7px;margin-left:20px;"> 开始日期:</span>
          <div class="pull-left" style="margin-left: 5px;">
            <input type="text" class="form-control" style="padding:4px 12px; ;width:105px;margin-left:5px;" placeholder="" id="runplan_input_startDate"  name="startDate" data-bind="value: searchModle().planStartDate" />
          </div>
          <span for="exampleInputEmail3" class="control-label pull-left" style="margin-left: 20px;margin-top: 7px;margin-left:20px;"> 截至日期:</span>
          <div class="pull-left" style="margin-left: 5px; ">
            <input type="text" class="form-control" style="padding:4px 12px; ;width:105px;margin-left:5px;" placeholder="" id="runplan_input_endDate"  name="endDate" data-bind="value: searchModle().planEndDate" />
          </div>
            <div class="pull-left" style="margin-left: 20px;"> <a type="button" class="btn btn-success btn-input blueBtn" style="margin-top:3px;" data-toggle="modal"
        ...
        <div id="plan_cross_default_panel" class="panel panel-default" style="margin-top:10px;padding-bottom:10px;">
          <div class="row" style="margin-top:10px">
            ...
            <div class="form-group pull-right" style="margin-left: 10px;">
             ...
             <a  type="button" class="btn btn-success greenBtn" data-toggle="modal" data-bind="attr:{class: searchModle().checkActiveFlag() == 1 ? 'btn btn-success greenBtn' : 'btn btn-success greenBtn disabled'}, click: checkCrossInfo" data-target="#" id="btn_cross_delete" style="margin-left: 20px;">
               <i class="fa fa-legal"></i>审核
	            ...
	            <a type="button" class="btn btn-success" data-toggle="modal" data-target="#" data-bind="click: modalRun">
		         ...
		         <a  type="button" class="btn btn-success redBtn" data-toggle="modal" data-target="#" id="btn_cross_delete" style="margin-left: 20px;margin-right:20px;" data-bind="attr:{class: searchModle().activeFlag() == 1 ? 'btn btn-success redBtn' : 'btn btn-success redBtn disabled'}, click: deleteCrosses">
	         ...
	         <div class="form-group" style="margin-left: 10px;">
		         <a  type="button" class="btn btn-success redBtn" data-toggle="modal" data-target="#" id="btn_cross_delete" style="margin-left: 18px;" data-bind="attr:{class: searchModle().activeFlag() == 1 ? 'btn btn-success' : 'btn btn-success disabled'}, click: deleteCrosses">
			         <i class="fa fa-trash-o"></i>删除
		         </a>
            </div>
	         </shiro:hasPermission>
                  ...
                  <tr style="height: 25px">
                    ...
                    <th align="center">  
						<div style="position: relative;">
						 <label for="exampleInputEmail5" style="font-weight: bold;vertical-align: bottom;">车底交路</label> 
					...
					<th style="width: 80px" align="center">担当局</th>
					<th style="width: 90px" align="center">方案</th>
                    <th style="width: 80px" align="center">有效期</th>
                    <th style="width: 30px" align="center">审核状态</th>
                  </tr>
                </thead>
              </table>
                          ...
                          <table class="table table-bordered table-striped table-hover" style="border:0;">
                            <tbody data-bind="foreach: planCrossRows">
                              <tr data-bind=" visible: visiableRow,style:{color: $parent.currentCrossRow().planCrossId == planCrossId ? 'blue':''}" >
                                <td align="center" style="width:30px;height:15px !important;"><input type="checkbox" value="1" data-bind="attr:{class: activeFlag() == 1  || checkActiveFlag() == 1?  '' : 'ckbox disabled'},event:{change: $parent.selectCross}, checked: selected"></td>
                                <!-- <td style="width: 38px" data-bind="text: $index() + 1, event:{mousedown:$parent.showTrains}"></td> -->
                                ...
                                <td style="width: 30px" data-bind="text: tokenVehBureauShowValue, event:{mousedown:$parent.showTrains}"></td>
                                <!-- <td style="width: 38px" align="center">
                                	<a href="#" data-bind="click: $parent.chooseModalRun">
                                		<i data-bind="attr:{class: isAutoGenerateCss}"></i>
                                	</a>
                                </td>   -->                             
                             	<td style="width: 90px" align="center"  data-bind="text :chartName"></td>
                                <td style="width: 80px" align="center" data-bind="text :crossEndDate"></td>
                                <td style="width: 30px" align="center" data-bind="text :checkFlagText"></td>
                              </tr>
                            </tbody>
                          </table>
              </div>
  ...
  <ul><li class='vm-list'><i class='fa fa-eye'></i>&nbsp;<a data-bind="click:showhis" >&nbsp;审核记录</a></li>
 ...
 <div class="blankBox"></div>
  ...
  <div class="pull-right" style="width: 49%;" id="rightBox"> 
    <!-- Nav tabs -->
    <div class="panel panel-default" style="margin:-5px -7px 0 -6px;">
      <ul class="nav nav-tabs" style="margin-top:10px;margin-left:5px;margin-right:5px;background-color:#f5f5f5;" >
        <li class="active"><a  style="padding:3px 10px;" href="#home" data-toggle="tab" data-bind="click: toRunMapTab">交路图</a></li>
        <li><a style="padding:3px 10px;" href="#profile" data-toggle="tab" data-bind="click: toCrossTab">交路信息</a></li>
        <li style="float:right">
          <input type="checkbox" class="pull-left" style=" height:15px !important;" class="form-control" data-bind="checked: isShowRunPlans, event:{change: showRunPlans}"
							class="form-control">
      ...
      <div class="tab-content" >
              ...
              <div class="row" style="margin:5px 0 10px 0;">
                <form class="form-inline" role="form">
                  <div class="row" style="margin:5px 0 10px 50px;">
                    ...
                    倍｝ <span>
                    <input type="checkbox" style="height:15px !important;" id="canvas_checkbox_stationType_jt" name="canvas_checkbox_stationType" checked="checked" style="margin-left:10px">
                    简图</span>
                    <input type="checkbox" id="canvas_checkbox_trainTime" style="margin-left:10px;margin-top:2px;height:15px !important;"  value=""/>
                    显示时刻
                    &nbsp;&nbsp;车底：
        ...
        <div class="tab-pane " id="profile">
          <div class="row" style="margin: 0px 10px 10px 10px;">
            <div class="row" >
              <form class="form-horizontal crossHeight" role="form" data-bind="with: currentCross">
                <div class="row" style="margin: 0px 0 5px 0;">
                  <span for="exampleInputEmail3"
											class="control-label pull-left"> 车底交路名:&nbsp;</span>
                  ...
                  <span for="exampleInputEmail5" class="control-label pull-left" style="margin-left:40px"> 铁路线型:</span>
                  <div class="pull-left">
                    <input type="radio" class="pull-left" class="form-control" 
												style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
												class="form-control" data-bind="checked: highlineFlag" value="0" disabled>
                  </div>
                  <span for="exampleInputEmail5" class="control-label pull-left"> 普速</span>
                  <div class="pull-left">
                    <input type="radio" class="pull-left" class="form-control" 
												style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
												class="form-control" value="1" data-bind="checked: highlineFlag" disabled>
                  </div>
                  <span for="exampleInputEmail5" class="control-label pull-left"> 高铁</span>
                  <div class="pull-left">
                    <input type="radio" class="pull-left" class="form-control" 
												style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
												class="form-control" value="2" data-bind="checked: highlineFlag" disabled>
                  </div>
                  <span for="exampleInputEmail5" class="control-label pull-left"> 混合</span>
                </div>
                <div class="row" style="margin: 5px 0 0px 0;">
                  <span for="exampleInputEmail3"
												class="control-label pull-left"> 备用套跑交路名:&nbsp;</span>
                  <div class="pull-left">
                    <input type="text" class="form-control" style="width: 470px;" data-bind="value: crossSpareName">
                  </div>
                  <span for="exampleInputEmail5" style="margin-left: 40px;" class="control-label pull-left"> 开行状态:</span>
                  <div class="pull-left">
                    <input type="radio" class="pull-left" class="form-control"
                  ...
                  <span for="exampleInputEmail5" class="control-label pull-left"> 开行</span>
                  <div class="pull-left">
                    <input type="radio" class="pull-left" class="form-control"
                  ...
                  <span for="exampleInputEmail5" class="control-label pull-left"> 备用</span>
                  <div class="pull-left">
                    <input type="radio" class="pull-left" class="form-control"
                  ...
                  <span for="exampleInputEmail5" class="control-label pull-left"> 停运</span>
                </div>
                <div class="row" style="margin: 5px 0 0px 0;">
                  <div class="pull-left" style="width: 16%;">
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3"
												class="control-label pull-left"> 组数:&nbsp;</span>
                      <div class="pull-left">
                        <input type="text" class="form-control" style="width: 40px;" data-bind="value: groupTotalNbr">
                      </div>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail2" class="control-label pull-left">对数:&nbsp;</span>
                      <input type="text" class="form-control" style="width: 40px;" data-bind="value: pairNbr">
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5"  class="control-label pull-left"> 开始:&nbsp;</span>
                      <input type="text" class="form-control" style="width: 70px;"
													placeholder=""  data-bind="value: crossStartDate">
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 结束:&nbsp;</span>
                      <input type="text" class="form-control" style="width: 70px;"
                  ...
                  <div class="pull-left" style="width: 28%;">
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 普速规律:</span>
                      <input type="radio" class="pull-left" class="form-control"
													value="1" data-bind="checked: commonlineRule"
													style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
													class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 每日</span>
                      <input type="radio" class="pull-left" class="form-control"
													value="2" data-bind="checked: commonlineRule"
													style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
													class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 隔日</span>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5"  class="control-label pull-left"> 高线规律:</span>
                      <input type="radio" class="pull-left" class="form-control"
													value="1" data-bind="checked: highlineRule"
													style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
													class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 日常</span>
                      <input type="radio" class="pull-left" class="form-control"
													value="2" data-bind="checked: highlineRule"
													style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
													class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 周末</span>
                      <input type="radio" class="pull-left" class="form-control"
														value="3" data-bind="checked: highlineRule"
														style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
														class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 高峰</span>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 指定星期:&nbsp;</span>
                      <div class="pull-left">
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 指定日期:&nbsp;</span>
                      <div class="pull-left">
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 指定周期:&nbsp;</span>
                      <div class="pull-left">
                        <input type="text" class="form-control" style="width: 140px;"
                  ...
                  <div class="pull-left" style="width: 25%;">
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span class="control-label pull-left" style="margin-left: 32px;"> 担当局:&nbsp;</span>
                      <div class="pull-left"> 
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span  class="control-label pull-left" > 车辆/动车段:&nbsp;</span>
                      <div class="pull-left">
                        <input type="text" class="form-control" style="width: 90px;" data-bind="value: tokenVehDept">
                      </div>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span  class="control-label pull-left" style="margin-left: 30px;"> 动车所:&nbsp;</span>
                      <div class="pull-left">
                        <input type="text" class="form-control" style="width: 90px;" data-bind="value: tokenVehDepot">
                      </div>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3" style="margin-left: 5px;"
													class="control-label pull-left"> 客运担当局:&nbsp;</span>
                      <div class="pull-left"> 
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3" style="margin-left: 30px;"
												class="control-label pull-left"> 客运段:&nbsp;</span>
                      <div class="pull-left">
                  ...
                  <div class="pull-left" style="width: 30%;">
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3"
												class="control-label pull-left" > 运行区段:&nbsp;</span>
                      <input type="text" maxlength ="200" class="form-control pull-left" style="width: 182px;" data-bind="value: crossSection">
                      <span for="exampleInputEmail3"
												class="control-label pull-left" ><!-- 不能超过200字符 --></span>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3"
												class="control-label pull-left"  style="margin-left: 13px;" > 经由线:&nbsp;</span>
                      <input type="text" class="form-control" style="width: 182px;" data-bind="value: throughLine">
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3" 
													class="control-label pull-left"> 机车类型:&nbsp;</span>
                      <input type="text" class="form-control pull-left" style="width: 40px;" data-bind="value: locoType">
                      <span for="exampleInputEmail3" style="margin-left:10px"
													class="control-label pull-left"> 动车组车型:&nbsp;</span>
                      <input type="text" class="form-control pull-left" style="width: 60px;" data-bind="value: crhType">
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3"  style="margin-left: 26px;"
													class="control-label pull-left"> 其他:&nbsp;</span>
                      <input type="checkbox" class="pull-left" class="form-control"
											value="1" data-bind="checked: elecSupply"
											style="width: 20px; margin-top: 5px;height:15px !important;"
											class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 供电</span>
                      <input type="checkbox" class="pull-left" class="form-control"
											value="1" data-bind="checked: dejCollect"
											style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
											class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 集便</span>
                      <input type="checkbox" class="pull-left" class="form-control"
											value="1" data-bind="checked: airCondition"
											style="width: 20px; margin-left: 5px; margin-top: 5px;height:15px !important;"
											class="form-control">
                      <span for="exampleInputEmail5" class="control-label pull-left"> 空调</span>
                    </div>
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3"  style="margin-left: 26px;"
            ...
            <div class=""> 
              ...
              <div style="padding:10px 0;overflow: auto;">
                <div class="table-responsive" >
                  <table class="table table-bordered table-striped table-hover table-calendar" style="min-height:100px;">
                    <thead>
...
<div id="hisshow" class="easyui-dialog" title="审核记录"
			data-options="iconCls:'icon-save'"
			style="width: 750px; height: 600px;overflow-y: hidden;">
		
		 <div id="hisshow1" class="row" style="margin:0 5px 5px 5px;overflow: auto;">
		     <div class="table-responsive" > 
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlan/run_plan_gt_modify.js"></script>
