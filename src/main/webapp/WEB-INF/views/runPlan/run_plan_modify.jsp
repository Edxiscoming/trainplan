...
<div class="row" style="margin: -3px 13px 10px 7px;"> 
  ...
  <div class="pull-left top" style="width: 50%;height:100%" id="leftBox"> 
      ...
      <div>
        <div class="row"  style="width: 100%;">
          ...
          <div class="pull-left" style="margin-left: 5px;">
            <select style="padding:4px 12px; ;width:118px" id="everybureau" class="form-control" data-bind="options:searchModle().bureaus, value: searchModle().bureau, optionsText: 'shortName', optionsValue:'code',event:{change: bureauChange}">
            </select>
          </div>
          ...
          <span for="exampleInputEmail3" class="control-label pull-left" style="margin-left: 20px;margin-top: 7px;"> 截至日期:</span>
          <div class="pull-left" style="margin-left: 5px; ">
          ...
          <div class="pull-left" style="margin-left: 20px;margin-right:20px;"> 
            <a type="button" class="btn btn-success btn-input" style="margin-top:3px;" data-toggle="modal" data-target="#" id="btn_cross_search"  data-bind="click: loadCrosses"><i class="fa fa-search"></i>查询</a> 
          </div>
          </div>
        </div>
              ...
              <table class="table table-bordered table-striped table-hover" id="cross_table_crossInfo">
                <thead>
                  <tr style="height: 25px">
                    <th style="width: 30px;height:15px !important;" align="center"><input type="checkbox" style="margin-top:0" value="1" data-bind="checked: crossAllcheckBox, event:{change: selectCrosses}"></th>
                    <!-- <th style="width: 38px" align="center">序号</th>
                           -->              
                    <th align="center">  
						<div style="position: relative;">
						 <span for="exampleInputEmail5" style="font-weight: bold;vertical-align: bottom;">车底交路</span> 
                            ...
                            <tbody data-bind="foreach: planCrossRows">
                              <tr data-bind=" visible: visiableRow, style:{color: $parent.currentCrossRow().planCrossId == planCrossId ? 'blue':''}" >
                               ...
                               <!--  <td style="width: 38px" align="center" data-bind="text: $index() + 1,event:{mousedown:$parent.showTrains}"></td> -->
                                ...
                                <td style="width: 80px" align="center" data-bind="text: tokenVehBureauShowValue,event:{mousedown:$parent.showTrains}"></td>
    ...
    <div class="pull-left" style="width: 49%;"  id="rightBox"> 
    <!-- Nav tabs -->
    <div class="panel panel-default" style="margin:-5px -14px 0 0;">
      <ul class="nav nav-tabs" style="margin-top:10px;margin-left:5px;margin-right:5px;background-color:#f5f5f5;"  >
        <li class="active"><a style="padding:3px 10px;" href="#home" data-toggle="tab" data-bind="click: toRunMapTab">运行图</a></li>
              ...
              <div class="row" style="margin:5px 0 10px 0;">
                <form class="form-inline" role="form">
                  <div class="row" style="margin:5px 0 10px 50px;">
                    ...
                    倍｝ <span>
                    <input type="checkbox" id="canvas_checkbox_stationType_jt" name="canvas_checkbox_stationType" checked="checked" style="margin-left:10px;height:15px !important;">
                    简图</span>
              ...
              <form class="form-horizontal crossHeight" role="form" data-bind="with: currentCross">
                ...
                <div class="row" style="margin: 5px 0 0px 0;">
                  ...
                  <div class="pull-left" style="width: 28%;">
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail5"  class="control-label pull-left"> 高铁规律:</span>
                      <input type="radio" class="pull-left" class="form-control"
                  ...
                  <div class="pull-left" style="width: 30%;">
                    ...
                    <div class="row" style="margin: 5px 0 0px 0;">
                      <span for="exampleInputEmail3"  style="margin-left: 26px;"
												class="control-label pull-left"> 备注:&nbsp;</span>
                      <div class="pull-left">
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlan/run_plan_modify.js"></script>
