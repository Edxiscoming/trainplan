				        	...
				        	<div class="panel-body">   
								...
								<div class="pull-left" style="margin-left: 5px; ">
									...
									<div class="pull-left" style="margin-left: 13px;">
									        ...
									        <a  type="button" class="btn btn-success btn-input" data-toggle="modal" style="margin-left: 13px;" 
												data-target="#" id="btn_cross_createTrainLines" data-bind="click: createTrainLines"><i class="fa fa-external-link"></i>生成开行计划</a>	
									</div>   
