...
<div id="div_form" class="row" style="padding-bottom:10px;">
  <form class="form-horizontal" role="form">
    ...
    <a type="button" id="isSave" href="#" class="btn btn-success btn-xs" data-bind="click: savePathWay" style="float:right;margin-right:20px;margin-top:4px;"><i class="fa fa-floppy-o"></i>保存</a>
  </form>
</div>
      ...
      <div class="panel-body">
        ...
        -->
      	<!-- 时刻table end -->
					      ...
					      <!--panle-heading-->
					      <div class="row">
						  	<div class="row" style="margin:5px 0 10px 0;position: absolute;left: 361px;top:10px">
					        ...
					        <div class="table-responsive table-hover" id="time1" style=" overflow:auto;margin-top:30px;">
					          <table id="table_run_plan_train_times_edit" border="0" style="width:" class="table table-bordered table-striped table-hover">
					            <thead>
					              <tr>
					                <th style="vertical-align: middle;width:45px;" rowspan="2" class="text-center">序号</th>
					                <th style="vertical-align: middle;width:150px" rowspan="2" class="text-center"><div>站名</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 40px;"><b>*</b></label></div></th>
					                <th style="vertical-align: middle;width:" rowspan="2" class="text-center"><div>路局</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 30px;"><b>*</b></label></div></th>
								...
								<tbody  id="saveCmdTxtMl" data-bind="foreach: trainStns">
					              <tr>
					                  <td data-bind="click: $parent.setCMDTrainStnCurrentRec, text: ($index() + 1)"></td>
 					                  <td data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: nodeName}"><input name="input_cmdTrainTimes_stnName" class="form-control" data-bind="attr:{readonly:inputReadOnly},click: $parent.setCMDTrainStnCurrentRec, value: nodeName,event:{focus: stnNameTempOnfocus}"/></td>
					                  <td data-bind="click: $parent.setCMDTrainStnCurrentRec"><select style="width: 50px" class="form-control" data-bind="event:{change: $parent.checkValueRepeat},options:$parent.searchModle().bureauArray, value: bureauOptionWjdd, optionsText: 'text',attr:{id: ($index() + 1)+'jy100',disabled:inputReadOnly}"></select></td>
					              	  <!-- <td align="center" data-bind="click: $parent.setCMDTrainStnCurrentRec, text: arrTime"> -->
									  <!-- <td align="center" data-bind="click: $parent.setCMDTrainStnCurrentRec, text: dptTime"> -->
									  <td align="center"><input  style="text-align:center" class="form-control" data-bind="attr:{readonly:inputReadOnly},click: $parent.setCMDTrainStnCurrentRec, value: arrTime,style:{color: setColor() =='1' ? 'red':''}"/></td>
									  <td align="center"><input  style="text-align:center" class="form-control" data-bind="attr:{readonly:inputReadOnly},click: $parent.setCMDTrainStnCurrentRec, value: dptTime, style:{color: setColor() =='1' ? 'red':''}"/></td>
									  <td align="center" data-bind="click: $parent.setCMDTrainStnCurrentRec, text: stepStr, event:{change: stepStrChange}"></td>
									  <td align="center" data-bind="click: $parent.setCMDTrainStnCurrentRec, text: arrRunDays"></td>
									  <td align="center" data-bind="click: $parent.setCMDTrainStnCurrentRec, text: runDays"></td>
									  <td align="center"><input style="width:50px;text-align:center" data-bind="attr:{readonly:inputReadOnly},value: arrTrainNbr, event: {blur: sourceTrainNbrOnblur,change: sourceTrainNbrChange}" class="form-control"/></td>
								  	  ...
								  	  <td align="center"><input style="width:60px;text-align:center" class="form-control" data-bind="attr:{readonly:inputReadOnly},click: $parent.setCMDTrainStnCurrentRec, value: trackName"/></td>
								  	  
								  	  
								  	  <td data-bind="click:$parent.setCMDTrainStnCurrentRec,  attr:{title: jobItemsText}">
					                  ...
					                  <td data-bind="click:  $parent.setCMDTrainStnCurrentRec">
					                  	<select style="width: 45px" class="form-control" data-bind="attr:{disabled:inputReadOnly}, options:kyyyOptions, value: kyyy, optionsText: 'text', event:{change: setKyyy}"></select></td>
...
<script src="<%=basePath %>/assets/js/trainplan/runPlan/path_way.js"></script>
</body>
</html>
