			      ...
			      <div class="row" style="margin: -5px 15px 10px 10px;"> 
				        	<div class="panel-body">   
								...
								<div class="pull-left" style="margin-left: 5px;">
									<input style="padding:4px 12px; ;width:75px" class="form-control" value="<%=currentBureauShortName %>">
								</div>
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlan/run_plan_search.js"></script>
