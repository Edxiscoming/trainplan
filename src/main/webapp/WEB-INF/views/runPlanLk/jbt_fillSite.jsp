...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/jbt_fillSite.js"></script>
...
<input id="stnArray_hidden" type="hidden" value='${stnArray}'>
<!--以上为必须要的-->

<div class="row" style="margin-bottom:10px">
<div class="pull-left" style="width:50%;">
   <div id="" class="panel panel-default" style="height:683px;">
		      ...
		      <form class="form-horizontal" role="form">
		      	<div class="row">
			     	...
			     	<div style="margin-left:10px;margin-top:10px;margin-bottom:0;vertical-align: middle">
	  					<a type="button"  class="btn btn-success btn-input" data-toggle="modal" data-target="#" id="plan_construction_createRunLine"  data-bind="click: fillSite"><i class="fa fa-search"></i>补点</a>
	  			 	</div>
		     </div>    
			          ...
			          <table id ="runPlanLkCMD_table" class="table table-bordered table-striped table-hover">
			            <thead>
			              <tr>
			                ...
			                <th class="text-center" style="vertical-align: middle;width:80px">区段</th>
			                <th class="text-center" style="vertical-align: middle;width:90px">参照车次</th>
			                <th class="text-center" style="vertical-align: middle;width:90px">参照车次所属方案</th>
			              </tr>
			            </thead>
			            <tbody data-bind="foreach: runPlanLkTrainStnRows">
				           <tr>  
							...
							<td align="center" data-bind="text: trainNbr, attr:{title: trainNbr}"></td>
							<td align="center"  data-bind="text: chart, attr:{title: chart}"></td>
				        	</tr>
				        </tbody>
			          </table>
			    </div> 
...
<div class="pull-right" style="width:50%;padding-left:5px;"> 
    <!--分栏框开始-->
       ...
       <div class="row" style="margin:10px 0 10px 0;"> 
		      <form class="form-horizontal" role="form">
		      	<div class="row">
			      	<div class="">
		  				<div class="row">
					     	<div class="row" style="width: 100%; margin-top: 5px;">
						  		...
						  		<div style="margin: -26px 0 0 490px;">
			     	...
			     	<div style="margin-left:10px;margin-top:10px;margin-bottom:0;vertical-align: middle">
						<a type="button" class="btn btn-success btn-input" data-bind="click: setTrain"></i>设置参照车次</a>
						<a type="button" class="btn btn-success btn-input" style="margin-left: 5px;" data-toggle="modal" data-target="#"
										id="cross_train_save" data-bind="click: showCrossTrainTimeDlg2"><i class="fa fa-clock-o"></i>时刻表</a>
	  			 	</div>
		     </div>    
 ...
 <div class="row">
<!--  <div class="pull-left" style="width:50%;">
   <div id="" class="panel panel-default" style="height:400px;">
          ...
          <table class="table table-bordered table-striped table-hover" id="plan_runline_table_trainLine">
		        ...
		        <tr >
                  ...
                  <th style="width:">停时</th>
                   ...
                   <th style="width:">出发天数2</th>
                 </tr>
		        </thead>
		        <tbody data-bind="foreach: fillStnArray">
		           <tr>  
					<td align="center" data-bind=" text: $index() + 1"></td>
					<td data-bind="text: nodeName, attr:{title: nodeName}"></td>
