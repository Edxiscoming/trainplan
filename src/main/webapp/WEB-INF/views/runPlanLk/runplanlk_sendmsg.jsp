	   	...
	   	<div class="row" style="margin:15px 0 10px 0;">
		      <div style="width: 422px;margin: 20px auto 0 auto;"> 
		        ...
		        <div class="pull-left"> 
					 ...
					 <textarea id="userReason" style="width: 350px; height: 100px;" maxlength="100" disabled>${trainNbrs}</textarea>
				 </div>
		        <div class="pull-left"> 
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/runplanlk_sendmsg.js"></script>  
