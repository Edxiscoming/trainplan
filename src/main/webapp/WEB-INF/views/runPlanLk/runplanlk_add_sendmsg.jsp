...
<body class="Iframe_body" style="height:100%;margin:-9px -6px 0px -3px;width:100%" >
	 <div id="div_searchForm" class="row" style="margin:-15px 0 10px 0;"> 
	    <form class="form-horizontal cc" role="form">
	    	<input type="hidden" id="cmdTrainIds" value="${cmdTrainIds}"/>
	    	<input type="hidden" id="trainNbrs" value="${trainNbrs}"/>
	    	<input type="hidden" id="type" value="${type}"/>
	    	<input type="hidden" id="passBureaus" value="${passBureaus}"/>
	    	
	   	<div class="row" style="margin:15px 0 10px 0;">
		      <div style="width: 422px;margin: 20px auto 0 auto;"> 
		        <div class="row"> 
					 <label for="exampleInputEmail3" class="control-label pull-left" style="margin-top: 6px;margin-left: 0px;">类型:&nbsp;&nbsp;补充临客时刻</label>
				 </div>
		        <div class="row">
					 <label for="exampleInputEmail3" class="control-label row" style="margin-top: 6px;margin-left: 0px;">车次:&nbsp;&nbsp;${trainNbrs}</label>
					 <label for="exampleInputEmail3" class="control-label pull-left" style="margin-top: 6px;margin-left: 20px;">相关局:&nbsp;&nbsp;${passBureaus}</label>
				 </div>
		        <div class="row"> 
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/runplanlk_add_sendmsg.js"></script>  
