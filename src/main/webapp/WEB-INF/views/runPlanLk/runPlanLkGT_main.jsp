...
<body class="Iframe_body"
					...
					<div class="row" style="width: 100%; margin-top: 5px;">
						...
						<div class="pull-left" style="margin-left: 5px;">
							<input type="checkBox" class="pull-left" class="form-control"
								...
								style="margin-top: 9px; margin-left: 18px"
								; width: 20px;" class="form-control">
						</div>
						<label for="exampleInputEmail3" class="control-label pull-left"
					...
					<div class="row" style="margin-top: 5px;">
						...
						<!-- 
												...
												<div class="pull-left" style="margin-left: 5px;">
													<input type="checkBox" class="pull-left" class="form-control"
													value="1" data-bind="checked: searchModle().currentBureanFlag"
													style="margin-top: 9px;width: 20px;" class="form-control">
												</div>
												 -->
						<label for="exampleInputEmail3" class="control-label pull-left"
							style="margin-left: 20px; margin-top: 5px;"> 审核状态:</label>
						<div class="pull-left" style="margin-left: 5px;">
							<select style="padding: 4px 12px;; width: 115px"
						...
						<div class="pull-left" style="margin-left: 10px;">
							<a type="button" class="btn btn-success btn-input"
								data-toggle="modal" style="padding: 3px 10px;" data-target="#"
										...
										<tbody data-bind="foreach: planTrainLkRows" id="choicall">
											<tr
												...
												<td align="center" style="width: 24px"><input
													type="checkbox" value="1" name="testcheck"
 ...
 -->
	...
	<div id="run_plan_train_times_stop_dialog" class="easyui-dialog" title="停运"
		data-options="iconCls:'icon-save'"
		style="width: 880px; height: 400px;overflow: hidden;">
		...
		<script type="text/javascript"
			src="<%=basePath%>/assets/js/trainplan/runPlanLk/runPlanLkGT_main.js"></script>
