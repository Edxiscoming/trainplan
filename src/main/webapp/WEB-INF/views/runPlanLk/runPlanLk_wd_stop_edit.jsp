...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/runPlanLk_wd_cmd_stop_edit.js"></script>
          ...
          <div class="form-group">
            <label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:50px;">停运规律：</label>
			 ...
			 <label style="color:#ff3030;font-size: 20px;margin: 3px 0 0 2px;"><b>*</b></label>
			  <button type="button" style="margin-left:15px;" data-bind="click: $root.btnLoadSelectDate, enable: wdCmdRuleOption().code == '3' && !booleanValue()">加载</button> 
...
<!--  -->
	  ...
	  <div style="text-align:center;margin-left:40px">
        ...
        <button type="button" class="btn btn-info" data-bind="click: btnEventResetWdCmdTrain"  style="margin-left:10px">重置</button>
