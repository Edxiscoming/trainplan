...
-->
<!--以上为必须要的--> 
<div class="row" style="padding-top:10px;padding-bottom:10px;margin-left: -9px;margin-top: -3px;">
								  		...
								  		<div class="row">
								  			<div class="row" style="width: 100%; margin-top: 5px;">
										  		<div class="form-group" style="float:left;margin-left:20px;margin-bottom:0;">
												    ...
												    <div class="pull-left">
												        <input id="runPlanLk_cmd_input_startDate" type="text" class="form-control" style="width:140px;" placeholder="">
													</div>
										  	...
										  	<div class="row" style="width: 100%; margin-top: 5px;">
										  		<div class="form-group" style="float:left;margin-left:20px;margin-bottom:0;">
												    ...
												    <div class="pull-left">
												        <input id="runPlanLk_cmd_input_endDate" type="text" class="form-control" style="width:140px;" placeholder="">
													</div>
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left: 20px">令电类型:&nbsp;</label>
												    <div class="pull-left">
												    	<select class="form-control" style="width: 140px;display:inline-block;margin-left: 13px"
		...
		<div class="bs-example bs-example-tabs">
		    ...
		    <div id="myTabContent" class="tab-content" >
			  ...
			  <div id="pageDiv_ddj" class="tab-pane fade active in" >
			  		<!--  -->
					  <div style="margin-right:-590px; float:left; width:100%;margin-top: -13px;">
					    <!--分栏框开始-->
					          ...
					          <table id ="bjdd_jk_runPlanLkCMD_table" class="table table-bordered table-striped table-hover">
					            ...
					            <tbody data-bind="foreach: runPlanLkCMDRows">
					              <tr data-bind="style:{color: $parent.currentCmdTxtMl().cmdTxtMlItemId == cmdTxtMlItemId ? 'blue':''}">
					                ...
					                <td style="vertical-align: middle; text-align:center;" data-bind="click: $parent.setCurrentRec, html: createStateStr" style="padding-top:6px;"></td>
					              </tr>
					            </tbody>
					          </table>
					        </div>
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/runPlanLk_cmd_stopGT.js"></script>
</body>
