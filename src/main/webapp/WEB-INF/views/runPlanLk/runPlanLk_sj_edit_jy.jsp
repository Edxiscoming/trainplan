...
--> 
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/runPlanLk_sj_edit_jy.js"></script>
      ...
      <div class="panel-body row">
        <form id="hightLineCrewForm" class="bs-example form-horizontal" style="margin-top:10px;" data-bind="with : hightLineModel">
          <div class="form-group">
            <label class="col-md-3 col-sm-4 col-xs-4 control-label text-right">乘务交路2：</label>
