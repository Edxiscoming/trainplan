...
<ol class="breadcrumb">
 ...
 -->
<!--以上为必须要的--> 
<div class="panel panel-default" style="margin:15px -7px 5px 10px;">
		...
		<div class="bs-example bs-example-tabs">
		    ...
		    <div id="myTabContent" class="tab-content" >
			  ...
			  <div id="pageDiv_ddj" class="tab-pane fade active in" >
			  		<!--  -->
					  <div id="left_div" style="margin-right:-590px; float:left; width:100%;">
							...
							<div class="row" style="padding-top:10px;padding-bottom:10px;" >
							  <form class="form-horizontal" role="form" style="margin-left: 0px;">
							  	<div class="row">
							  		<div class="pull-left">
								  		<div class="row">
								  			<div class="row" style="width: 100%; margin-top: 5px; ">
										  		<div class="form-group" style="float:left;margin-left:0;margin-bottom:0;">
													...
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:12px;">&nbsp;&nbsp;路局令电号:&nbsp;</label>
												    <div class="pull-left">
												        <input type="text" class="form-control" style="width:130px;" data-bind="value: searchModle().cmdNbrBureau">
													</div>
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:22px;">铁总令电号:&nbsp;</label>
												    <div class="pull-left">
												        <input type="text" class="form-control" style="width:130px;" data-bind="value: searchModle().cmdNbrSuperior">
													</div>
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left: 13px">&nbsp;&nbsp;选线状态:&nbsp;</label>
												    <div class="pull-left">
										  	...
										  	<div class="row" style="width: 100%; margin-top: 5px;">
										  		<div class="form-group" style="float:left;margin-left:0;margin-bottom:0;">
													...
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left: 20px">令电类型:&nbsp;</label>
												    <div class="pull-left">
												    	<select class="form-control" style="width: 130px;display:inline-block;margin-left: 13px"
													...
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:53px;">&nbsp;&nbsp;车次:&nbsp;</label>
												    <div class="pull-left">
												        <input type="text" class="form-control" style="width:130px;" data-bind="value: searchModle().trainNbr">
												    </div>

													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left: 13px">&nbsp;&nbsp;生成状态:&nbsp;</label>
												    <div class="pull-left">
												    	<select class="form-control" style="width: 130px;display:inline-block;"
							  		...
							  		<div style="float:left;margin-left:20px;margin-top: 36px;margin-bottom:0;vertical-align: middle">
 ...
 -->					        
					          ...
					          <table id ="bjdd_jk_runPlanLkCMD_table" class="table table-bordered table-striped table-hover">
					            <thead>
					              <tr>
					                ...
					                <th class="text-center" style="vertical-align: middle;width:50px">项号</th>
					                ...
					                <th class="text-center" style="vertical-align: middle;width:180px">择日</th>
					                 <th class="text-center" style="vertical-align: middle;width:50px">重点</th>
					                <th class="text-center" style="vertical-align: middle;width:140px">途经局</th>
					                <th class="text-center" style="vertical-align: middle;width:50px">选线<br>状态</th>
					                <th class="text-center" style="vertical-align: middle;width:50px">生成<br>状态</th>
					            ...
					            <tbody data-bind="foreach: runPlanLkCMDRows">
					              <tr data-bind="style:{color: $parent.currentCmdTxtMl().cmdTxtMlItemId == cmdTxtMlItemId ? 'blue':''}">
					              	<td><input name="cmd_list_checkbox" value="1" type="checkbox" data-bind="event:{change:$parent.setCurrentRec1 },checked: isSelect " ></td>
					          ...
					          <table id ="bjdd_jk_runPlanLkCMD_table_wd" class="table table-bordered table-striped table-hover">
					            <thead>
					              <tr>
					                ...
					                <th class="text-center" style="vertical-align: middle;width:90px">截至日期</th>
					                     <th class="text-center" style="vertical-align: middle;width:50px">规律</th>
					                <th class="text-center" style="vertical-align: middle;width:160px">择日日期</th>
					      ...
					      <div class="panel-body" style="padding:5px 5px;">
							<div class="row" style="width: 100%; margin-top: 5px;margin-bottom: 5px;">
						  		<div class="form-group" style="float:left;margin-bottom:0;">
									...
									<label style="color:#ff3030;font-size: 20px;margin-left:3px"><b>*</b></label>
					        ...
					        <div class="table-responsive table-hover" style=" overflow:auto;"  id="time1">
					          <table id="runPlanLkCMD_trainStn_table" border="0" style="width:1300px" class="table table-bordered table-striped table-hover table-cc">
					            <thead>
					              <tr>
					                <th style="vertical-align: middle;width:30px;" rowspan="2" class="text-center">序号</th>
					                <th style="vertical-align: middle;width:200px" rowspan="2" class="text-center"><div style="margin-top:7px">站名</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 40px;"><b>*</b></label></div></th>
					                <th style="vertical-align: middle;width:80px" rowspan="2" class="text-center"><div style="margin-top:7px">路局</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 40px;"><b>*</b></label></div></th>
					                <th style="vertical-align: middle;width:85px" rowspan="2" class="text-center"><div style="margin-top:7px">到达时间</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 65px;"><b>*</b></label></div></th>
					                <th style="vertical-align: middle;width:85px" rowspan="2" class="text-center"><div style="margin-top:7px">出发时间</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 65px;"><b>*</b></label></div></th>
				                    ...
				                    <th style="vertical-align: middle;width:px" rowspan="2">客运</th>
				                    <th style="width: 11px"  rowspan="2" align="center"></th>
		              ...
		              <div style="overflow-y:auto;width:1300px;" id="time1">
		                  <table id="ddddddd" class="table table-bordered table-striped table-hover table-cc" style="border:0;">
								<tbody id="saveCmdTxtMl" data-bind="foreach: runPlanLkCMDTrainStnRows">
					              <tr data-bind="style:{color: $root.currentCmdTrainStn().childIndex == childIndex ? 'blue':''}">
					                <td style="width:30px;" data-bind="click: $parent.setCMDTrainStnCurrentRec, text: ($index() + 1)"></td>
 					                  <!-- <td data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: stnNameTemp}"><input name="input_cmdTrainTimes_stnName" class="form-control" data-bind="click: $parent.setCMDTrainStnCurrentRec, value: stnNameTemp,event:{focus: stnNameTempOnfocus}"/></td> -->
 					                  <td style="width:200px;" data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: nodeName}"><input name="input_cmdTrainTimes_stnName" class="form-control" data-bind="click: $parent.setCMDTrainStnCurrentRec, value: nodeName,event:{keyup:stnNameKeyUp,focus: stnNameTempOnfocus}" oninput="checkValueRepeat();" onpropertychange="checkValueRepeat();"/></td>
 					             <!--   
 					             <input name="ddlOrgCity" type="text" data-bind="click: $parent.setCMDTrainStnCurrentRec, value: stnNameTemp,attr:{id: ($index() + 1)+'gt'}" onkeydown="item_suggest.item_display(this,'',event);" oninput="checkValueRepeat();" onpropertychange="checkValueRepeat();" class="form-control">
 					                 --> 
 					                </td>
 					               <td style="width:80px;" data-bind="click: $parent.setCMDTrainStnCurrentRec"><select style="width: 70px" class="form-control" data-bind="event:{change: $parent.checkValueRepeat},options:$parent.searchModle().bureauArray, value: bureauOptionWjdd, optionsText: 'text' ,attr:{id: ($index() + 1)+'gt100'}"></select></td>
					                ...
					                <td style="width:70px;" data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: arrRunDays}"><input class="form-control" data-bind="event:{change: $parent.checkValueRepeat,keyup:arrKeyUp,blur:arrRunDaysOnblur},click: $parent.setCMDTrainStnCurrentRec, value: arrRunDays"/></td>
					                <td style="width:70px;" data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: dptRunDays}"><input class="form-control" data-bind="event:{change: $parent.checkValueRepeat,keyup:dptKeyUp,blur:dptRunDaysOnblur},click: $parent.setCMDTrainStnCurrentRec, value: dptRunDays"/></td>
					                ...
					                <td style="width:90px;" data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: arrTrainNbr}"><input class="form-control" maxlength="20" data-bind="event:{blur: sourceTrainNbrOnblur},click: $parent.setCMDTrainStnCurrentRec, value: arrTrainNbr"/></td>
					                  ...
					                  <td data-bind="click:  $parent.setCMDTrainStnCurrentRec">
					                  	<select style="width: 70px" class="form-control" data-bind="options:kyyyOptions, value: kyyy, optionsText: 'text', event:{change: setKyyy}"></select></td>
					                  
					               <td style="width: 5px" align="center" class="td_17 "></td>
	        ...
	        <div id="pageDiv_bjxg" class="tab-pane fade">
	        	<!-- tab2内容开始 -->
	        		<!--  -->
					  <div id="right_div" style="margin-right:-590px; float:left; width:100%;">
					    <!--分栏框开始-->
					    <div id="right_div_panel" class="panel" style="margin:0 532px 10px 0;">
							<div class="row" style="padding-top:10px;padding-bottom:10px;">
							  <form class="form-horizontal" role="form">
							  	<div class="row">
								  		...
								  		<div class="row">
								  			<div class="row" style="width: 100%; margin-top: 5px;">
										  		<div class="form-group" style="float:left;margin-left:3px;margin-bottom:0;">
													...
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:10px;">铁总令电号:&nbsp;</label>
												    <div class="pull-left">
												        <input type="text" class="form-control" style="width:130px;" data-bind="value: searchModle().cmdNbrSuperior">
													</div>
										  	...
										  	<div class="row" style="width: 100%; margin-top: 5px;">
										  		<div class="form-group" style="float:left;margin-left:3px;margin-bottom:0;">
													...
													<label for="exampleInputEmail2" class="control-label pull-left" style="margin-left:10px;">令电类型:&nbsp;</label>
												    <div class="pull-left">
												    	<select class="form-control" style="width: 130px;display:inline-block;margin-left:13px;"
							  		...
							  		<div style="float:left;margin-left:20px;margin-top: 25px;margin-bottom:0;vertical-align: middle">
							  			<a type="button" href="#" class="btn btn-success btn-input" data-bind="click : queryListWjdd" style="float:left;margin-left:20px;margin-bottom:0;"><i class="fa fa-search"></i>查询</a>
							  		</div>
							  	</div>
							  </form>
							</div>
					          ...
					          <table class="table table-bordered table-striped table-hover">
					            <thead>
					              <tr>
					                ...
					                <th class="text-center" style="vertical-align: middle;width:160px">择日</th>
					                <th class="text-center" style="vertical-align: middle;width:140px">途经局</th>
					                <th class="text-center" style="vertical-align: middle;width:50px">担当<br>局</th>
					      ...
					      <div class="panel-body" style="padding:5px 5px;" >
							<div class="row" style="width: 100%; margin-top: 5px;margin-bottom: 5px;">
						  		<div class="form-group" style="float:left;margin-bottom:0;">
						  			<label for="exampleInputEmail2" class="control-label pull-left text-right" style="width:70px;">途经局:&nbsp;</label>
								    <div class="pull-left">
								        <input disabled="disabled" id="runPlanLk_cmd_input_tjj_wjdd" class="form-control" data-bind="value:currentCmdTxtMl().passBureau" style="width:360px;height:23px"></input>
									</div>
									<label style="color:#ff3030;font-size: 20px;margin-left:3px"><b>*</b></label>
									<!-- <div class="pull-left" style="margin-left:345px;">
								        <button type="button" class="btn btn-success btn-xs" data-bind="click: saveCmdTxtMl"><i class="fa fa-floppy-o"></i> 保存</button>
					        ...
					        <div class="table-responsive table-hover" style=" overflow:auto;" id="time2">
					          <table id="runPlanLkCMD_trainStn_table" border="0" style="width:1300px" class="table table-bordered table-striped table-hover">
					            <thead>
					              <tr>
					                <th style="vertical-align: middle;width:30px;" rowspan="2" class="text-center">序号</th>
					                 <th style="vertical-align: middle;width:200px" rowspan="2" class="text-center"><div style="margin-top:7px">站名</div><div><label style="color:#ff3030;font-size: 20px;margin: -20px 0 0 40px;"><b>*</b></label></div></th>
 ...
 <!-- 
 					                <td data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: stnNameTemp}">
							<input name="ddlOrgCity" type="text" data-bind="event:{change: $parent.checkValueRepeat},click: $parent.setCMDTrainStnCurrentRec, value: stnNameTemp,attr:{id: ($index() + 1)+'wjgt'}" onkeydown="item_suggest.item_display(this,'',event);" class="form-control"> 					                
 					                 -->
 					                </td>

 
 					             <td style="width:80px;" data-bind="click: $parent.setCMDTrainStnCurrentRec"><select style="width: 70px" class="form-control" data-bind="event:{change: $parent.checkValueRepeat},options:$parent.searchModle().bureauArray, value: bureauOptionWjdd, optionsText: 'text',attr:{id: ($index() + 1)+'wjgt100'}"></select></td>
					                <td style="width:85px;" data-bind="click: $parent.setCMDTrainStnCurrentRec, attr:{title: arrTime}">
					                	<input class="form-control keydown_change" data-bind="click: $parent.setCMDTrainStnCurrentRec, style:{color: setColor() =='1' ? 'red':''},value: arrTime, event: {change: $parent.checkValueRepeat,blur: arrTimeOnblur,keyup:arrTimeKeyUp}"/>
					                	<span data-bind="validationMessage: arrTime"></span>
					                </td>
					                ...
					                <td style="width:270px;" data-bind="click:$parent.setCMDTrainStnCurrentRec,  attr:{title: jobItemsText}">
					                  ...
					                  <td data-bind="click:  $parent.setCMDTrainStnCurrentRec">
					                  	<select style="width: 70px" class="form-control" data-bind=" click:  $parent.setCMDTrainStnCurrentRec,  options:kyyyOptions, value: kyyy, optionsText: 'text'"></select></td>
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/runPlanLk/runPlanLk_cmd_addGT.js"></script>
