		...
		data-options="iconCls:'icon-save'"> 
			      ...
			      <div class="fix fix_nav">
				       <ul class="nav nav-tabs" >
						...
						<!-- Tab panes -->
						<div class="tab-content fix_content" >
						  <div class="tab-pane active" id="simpleTimes" > 
						    <div class="table-auto" style="overflow: auto;">
					      	...
					      	<div class=" table-auto" style="overflow: auto;">        							        
												 <div id="simpleTimes_table" class=""> 
													<table class="table table-bordered table-striped table-hover" >
			        	...
			        	<div class="tab-pane" id="allTimes" > 
			        	 <div class="table-auto">
					      	...
					      	<div class="table-auto" style="overflow:auto;"> 
												 <div id="allTimes_table"  class=""> 
<!-- 												 <div id="allTimes_table"  class="table_content">  -->
													<table class="table table-bordered table-striped table-hover" > 
...
<script type="text/javascript" src="<%=basePath %>/assets/js/trainplan/trainTimes/stn_train_times.js"></script>  
