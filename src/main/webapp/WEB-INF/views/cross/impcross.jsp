...
<body class="Iframe_body" style="margin:-8px -8px 0px -19px;width:100%" >
									   ...
									   <div class="row" style="width: 100%;height:50px" >
										...
										<div class="row"  style="width: 100%; margin-top: 5px;">
											...
											<input type="checkBox" class="pull-left" class="form-control"
												...
												class="form-control"> 
											<label for="exampleInputEmail5" class="control-label pull-left" style="margin-top:5px;margin-right:20px">
												本局相关</label> 
											<label for="exampleInputEmail3" class="control-label pull-left" style="margin-top:5px;">
												车次:&nbsp;</label>
											<div class="pull-left">
																...
																<table class="table table-bordered table-striped table-hover" style="border-top:0;text-align:center" id="table_left">
																	...
																	<tbody data-bind="foreach: crossRows.rows">
																		<tr data-bind=" visible: visiableRow, style:{color: $parent.currentCross().crossId == crossId ? 'rgb(21, 124, 255)':''}" >
																			...
																			<td><div style="background-color:#ec9820;border-radius:10px">未</div></td>
																			<td><button style="background-color:#3172a9;border-radius:10px 0 0 10px;margin-right:5px">通</button><button style="background-color:#d04541;border-radius:0 10px 10px 0;margin-left:5px">不</button></td>
																		</tr> 
																	</tbody>
																</table>
	...
	<!-- Jess 把宽度从69%改为34% -->
	<div class="pull-right" style="width: 34%;" id="rightBox"> 
			        ...
			        <div class="panel-heading">
			          ...
			          <div class="panel-body">
						<div class="row" >
							<form class="form-horizontal" role="form" data-bind="with: currentCross"> 
							      <div class="row" style="margin: 3px;border-width:1px;border-color:#ccc;border-style:none none dashed none ; "> 
							         <div class="row">        
										<div>
								    ...
								    <div class="row">	
										...
										<label for="exampleInputEmail3"
											class="control-label pull-right" style="margin:auto 0px"> 车底交路名:&nbsp;</label>
								    </div> 
									 <div class="row">	
										<div>
											<input type="text" class="form-control pull-right" style="width:75%;margin:5px" data-bind="value: crossName"
						...
						<div  style="border-width:1px;border-color:#ccc;border-style:none none dashed none;padding:10px">
					 ...
					 <div style="border-width:1px;border-color:#ccc;border-style:none none dashed none;padding:10px">
						                <div class="row" style="margin: 5px 0 0px 0;">
											<label for="exampleInputEmail3"
												class="control-label pull-left" style="margin-left: 26px;"> 运行区段:&nbsp;</label>
											<input type="text" maxlength="200" class="form-control pull-left" style="width: 182px;"  >
											<label for="exampleInputEmail3"
												class="control-label pull-left" > <!-- 不能超过200字符 --></label>
										</div>
										<div class="row" style="margin: 5px 0 0px 0;">
											<label for="exampleInputEmail3"
												class="control-label pull-left"  style="margin-left: 13px;" > 经由铁路线:&nbsp;</label>
											<input type="text" class="form-control" maxlength="30" style="width: 182px;"  >
										</div> 
						</div>
						<div style="border-width:1px;border-color:#ccc;border-style:none none dashed none;padding:10px">
							 <div class=" "> 
							        <div class="row"><span class="pull-left" style="margin:5px">车辆担当</span></div>
								    <div class="row" style="margin: 5px 0 0px 0;">
										<label class="control-label pull-left" > 局:&nbsp;</label>
										<div class="pull-left">
								   ...
								   <div style="border-width:1px;border-color:#ccc;border-style:none none dashed none;padding:10px" > 
										...
										<div class="row" style="margin: 5px 0 0px 0;">
											...
											<input type="text"  class="form-control pull-left" style="width: 160px;margin-left:13px" data-bind="value: locoType">
									    </div>
									    <div class="row" style="margin: 5px 0 0px 0;">
											<label for="exampleInputEmail3" style="margin-left:10px"
													class="control-label pull-left"> 动车组车型:&nbsp;</label> 
											<input type="text" class="form-control pull-left" style="width: 160px;" data-bind="value: crhType">
										</div>
									<div class="row" style="margin: 5px 0 0px 0;">
										<label for="exampleInputEmail5" class="control-label pull-left margin-2" style="margin-left:10px">
											供电</label> 
										<input type="text" class="pull-left" class="form-control"
											value="1" data-bind="checked: elecSupply"
											style="width: 60px; margin-top: 5px;text-align:center;"
											class="form-control">
										...
										<input type="text" class="pull-left" class="form-control"
											...
											style="width: 60px; margin-left: 5px; margin-top: 5px; text-align:center;
											class="form-control">
										<label for="exampleInputEmail5" class="control-label pull-left margin-2" style="margin-left:40px">
											空调</label>  
										<input type="text" class="pull-left" class="form-control"
									  ...
									  <div class="row">
										...
										<div class=" row">
											<input type="text" class="form-control" style="margin-left: 26px;width: 90%;height:100px" ><!-- data-bind="value: note" -->
										</div> 
						    </div> 
						</form>
					    </div>
