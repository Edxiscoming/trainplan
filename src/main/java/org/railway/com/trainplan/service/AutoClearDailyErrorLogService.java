...
@Transactional
@Monitored
public class AutoClearDailyErrorLogService extends QuartzJobBean {

	private static Log logger = LogFactory.getLog(AutoClearDailyErrorLogService.class
			.getName());
	...
	protected void executeInternal(JobExecutionContext context)
		...
		//注入服务类
		 try {
			...
			dailyPlanLogService = applicationContext.getBean("dailyPlanLogService", DailyPlanLogService.class);
