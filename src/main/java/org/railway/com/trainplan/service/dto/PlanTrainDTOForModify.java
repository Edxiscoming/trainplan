...
public class PlanTrainDTOForModify implements Serializable {
	/**
	 * 
	 */
	...
	private String cmdTrainId;// 命令id
	private String telId;// 电报id
	...
	public PlanTrainDTOForModify() {
		super();
	}

	public PlanTrainDTOForModify(Map<String, Object> m) {
		this.planTrainId = MapUtils.getString(m, "PLAN_TRAIN_ID");
		this.planCrossId = MapUtils.getString(m, "PLAN_CROSS_ID");
		this.crossName = MapUtils.getString(m, "CROSS_NAME");
		this.runDate = MapUtils.getString(m, "RUN_DATE");
		this.trainNbr = MapUtils.getString(m, "TRAIN_NBR");
		this.creatType = MapUtils.getString(m, "CREAT_TYPE");
		this.telId = MapUtils.getString(m, "TEL_ID");
		this.cmdTrainId = MapUtils.getString(m, "CMD_TRAIN_ID");
	}
