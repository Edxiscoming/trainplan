...
public class StringUtil {
	...
	public static void main(String[] args) {
		LocalDate LsatDate = DateTimeFormat.forPattern("yyyyMMdd")
				.parseLocalDate("20150214");
		LocalDate nowDate = DateTimeFormat.forPattern("yyyyMMdd")
				.parseLocalDate(
						DateUtil.getStringFromDate(new Date(), "yyyyMMdd"));

		int initInterval = Days.daysBetween(LsatDate, nowDate).getDays();
		System.out.println(initInterval);

		LocalDate runPlanStartDate = DateTimeFormat.forPattern("yyyyMMdd")
				.parseLocalDate("20140228");
		LocalDate runPlanEndDate = DateTimeFormat.forPattern("yyyyMMdd")
