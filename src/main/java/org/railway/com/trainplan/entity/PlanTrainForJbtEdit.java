...
public class PlanTrainForJbtEdit implements Serializable {
	...
	private String sourceTimeActivity;
	private String targetTimeActivity;
	...
	private String sourceDays;
	private String sourceHour;
	private String sourceMin;
	private String sourceSecend;
	private String targetDays;
	private String targetHour;
	private String targetMin;
	private String targetSecend;
	...
	public void setLastTimeText(String start,String end) {
		
		int betweenMinite = DateUtil.getBetweenMinite(start, end);
		int days = betweenMinite/(24*60);
		int hours = (betweenMinite-days*24*60)/60;
		int min = betweenMinite-hours*60;
		StringBuffer lastTimeTextBuf = new StringBuffer();
		if(days>0){
			lastTimeTextBuf.append(days).append(" 天 ");
		}
		if(hours>0){
			lastTimeTextBuf.append(hours).append(" 小时 ");
		}
		if(min>0){
			lastTimeTextBuf.append(min).append(" 分钟 ");
		}
		this.lastTimeText = lastTimeTextBuf.toString();
	}

	public String getSourceTimeActivity() {
		return sourceTimeActivity;
	}

	public void setSourceTimeActivity(String sourceTimeActivity) {
		this.sourceTimeActivity = sourceTimeActivity;
	}

	public String getTargetTimeActivity() {
		return targetTimeActivity;
	}

	public void setTargetTimeActivity(String targetTimeActivity) {
		this.targetTimeActivity = targetTimeActivity;
	}
	...
	public String getSourceDays() {
		return sourceDays;
	}

	public void setSourceDays(String sourceDays) {
		this.sourceDays = sourceDays;
	}

	public String getSourceHour() {
		return sourceHour;
	}

	public void setSourceHour(String sourceHour) {
		this.sourceHour = sourceHour;
	}

	public String getSourceMin() {
		return sourceMin;
	}

	public void setSourceMin(String sourceMin) {
		this.sourceMin = sourceMin;
	}

	public String getSourceSecend() {
		return sourceSecend;
	}

	public void setSourceSecend(String sourceSecend) {
		this.sourceSecend = sourceSecend;
	}
	...
	public String getTargetSecend() {
		return targetSecend;
	}

	public void setTargetSecend(String targetSecend) {
		this.targetSecend = targetSecend;
	}
