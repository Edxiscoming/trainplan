 ...
 * 
 */
public class PlanCrossCmd implements Serializable {
	 ...
	 * ��·�ƻ���Ӧ���г����мƻ�
	 */
	private List<PlanTrainCMD> trainList;
	...
	public List<PlanTrainCMD> getTrainList() {
		return trainList;
	}

	public void setTrainList(List<PlanTrainCMD> trainList) {
	...
	public String getrBureau() {
		return rBureau;
	}

	public void setrBureau(String rBureau) {
		this.rBureau = rBureau;
	}
