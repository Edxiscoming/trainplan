...
public class TrainTimeInfoJbt {
	...
	private String trainlineTempId;
	 ...
	 private String jobsValue;//<始发>	<经由><终到>
	...
	private String SOURCE_TIME_SCHEDULE_HOUR;
	private String SOURCE_TIME_SCHEDULE_MINUTE;
	private String SOURCE_TIME_SCHEDULE_SECOND;
	private String TARGET_TIME_SCHEDULE_HOUR;
	private String TARGET_TIME_SCHEDULE_MINUTE;
	private String TARGET_TIME_SCHEDULE_SECOND;
	...
	public String getSOURCE_TIME_SCHEDULE_HOUR() {
		return SOURCE_TIME_SCHEDULE_HOUR;
	}
	public void setSOURCE_TIME_SCHEDULE_HOUR(String sOURCE_TIME_SCHEDULE_HOUR) {
		SOURCE_TIME_SCHEDULE_HOUR = sOURCE_TIME_SCHEDULE_HOUR;
	}
	public String getSOURCE_TIME_SCHEDULE_MINUTE() {
		return SOURCE_TIME_SCHEDULE_MINUTE;
	}
	public void setSOURCE_TIME_SCHEDULE_MINUTE(String sOURCE_TIME_SCHEDULE_MINUTE) {
		SOURCE_TIME_SCHEDULE_MINUTE = sOURCE_TIME_SCHEDULE_MINUTE;
	}
	public String getSOURCE_TIME_SCHEDULE_SECOND() {
		return SOURCE_TIME_SCHEDULE_SECOND;
	}
	public void setSOURCE_TIME_SCHEDULE_SECOND(String sOURCE_TIME_SCHEDULE_SECOND) {
		SOURCE_TIME_SCHEDULE_SECOND = sOURCE_TIME_SCHEDULE_SECOND;
	}
	public String getTARGET_TIME_SCHEDULE_HOUR() {
		return TARGET_TIME_SCHEDULE_HOUR;
	}
	public void setTARGET_TIME_SCHEDULE_HOUR(String tARGET_TIME_SCHEDULE_HOUR) {
		TARGET_TIME_SCHEDULE_HOUR = tARGET_TIME_SCHEDULE_HOUR;
	}
	public String getTARGET_TIME_SCHEDULE_MINUTE() {
		return TARGET_TIME_SCHEDULE_MINUTE;
	}
	public void setTARGET_TIME_SCHEDULE_MINUTE(String tARGET_TIME_SCHEDULE_MINUTE) {
		TARGET_TIME_SCHEDULE_MINUTE = tARGET_TIME_SCHEDULE_MINUTE;
	}
	public String getTARGET_TIME_SCHEDULE_SECOND() {
		return TARGET_TIME_SCHEDULE_SECOND;
	}
	public void setTARGET_TIME_SCHEDULE_SECOND(String tARGET_TIME_SCHEDULE_SECOND) {
		TARGET_TIME_SCHEDULE_SECOND = tARGET_TIME_SCHEDULE_SECOND;
	}
	...
	public void setJobsValue(String jobsValue) {
