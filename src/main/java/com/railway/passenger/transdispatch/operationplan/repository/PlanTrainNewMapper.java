...
public interface PlanTrainNewMapper {
    ...
    /**
     * 
     * @Description: 根据计划交路ID获取其第一个rundate日期的车次信息
     * @param @param planCrossId
     * @param @return   
     * @return PlanTrainNew  
     * @throws
     ...
     * @date 2015年11月9日
     */
    PlanTrainNew selectFirstRunDatePlanTrain(String planCrossId);
    
    /**
     * 
     * @Description: 查询连线用的交路
     * @param @param param
     * @param @return   
     * @return PlanTrainNew  
     * @throws
     ...
     * @date 2015年11月9日
     */
    PlanTrainNew selectLinkedPlanTrain(Map<String, Object> param);
