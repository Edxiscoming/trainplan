...
/**
 * 基本图列车经由站信息(仅记录变动了的数据)
 */
public class TCmTrainStn {
    /**
     * 车站ID
     */
    private String cmTrainStnId;
	 ...
	 *            车站ID
     */
    public void setCmTrainStnId(String cmTrainStnId) {
        this.cmTrainStnId = cmTrainStnId;
    }
