 ...
 *
 */
public class TCmOriginalCross {
    /**
     * 原始对数表信息ID（本表ID）
     */
    private String cmOriginalCrossId = UUID.randomUUID().toString();
     ...
     * 未审核的路局
     */
    private String check_n;
    /**
     * 本局审核情况
     */
    private String check_wor;
    ...
    public String getCheck_wor() {
		return check_wor;
	}


	public void setCheck_wor(String check_wor) {
		this.check_wor = check_wor;
	}


	public String getCheck_t() {
		return check_t;
	}


	public void setCheck_t(String check_t) {
	...
	public String getCheck_n() {
		return check_n;
	}


	public void setCheck_n(String check_n) {
		this.check_n = check_n;
	}


	public String getAllCheckFlag() {
		return allCheckFlag;
	}

    
	public void setAllCheckFlag(String allCheckFlag) {
